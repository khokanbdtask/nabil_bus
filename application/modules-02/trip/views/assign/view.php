                ...
                <table class="table table-hover" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php foreach ($driver as $dname): ?>
                                <?php if ($assign->driver_name != $dname->name): ?>
                                   , <?php echo $dname->name; ?>
                                <?php endif; ?>
                    ...
                    <tr>
                      ...
                      <?php
                            ...
                            ?>
                        <?php foreach ($assistant as $aname): ?>
                                <?php if( ($assign->assistant_1_name != $aname->name )&&($assign->assistant_2_name != $aname->name)&&($assign->assistant_3_name != $aname->name)): ?>
                                   , <?php echo $aname->name; ?>
                                <?php endif; ?>
