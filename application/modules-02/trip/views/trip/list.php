        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <a href="<?php echo base_url('trip/trip/form') ?>" class="btn btn-sm btn-info" title="Add"><i
                    ...
                    <table class="datatable table table-bordered table-hover">
                        ...
                        <?php foreach ($trps as $trips) { ?>
                            <tr>
                                ...
                                <td><?php echo $trips->stoppages; ?></td>
                                ...
                                <td>
                                    ...
                                    <?php if ($this->permission->method('trip', 'update')->access()): ?>
                                        <a href="<?php echo base_url("trip/trip/form/$trips->trip_id") ?>"
                                    ...
                                    <?php if ($this->permission->method('trip', 'delete')->access()): ?>
                                        <a href="<?php echo base_url("trip/trip/delete/$trips->trip_id") ?>"
