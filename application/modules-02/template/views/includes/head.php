...
<!-- <meta http-equiv="refresh" content="180;url=<?php echo base_url('logout') ?>" /> -->
<!-- New code 2021 direct update  -->
...
<!-- Bootstrap rtl -->
<?php if (isset($setting->site_align) && $setting->site_align =='RTL') { ?>
...
<!-- Tokenfield CSS -->
<link href="<?php echo base_url('assets/css/tokenfield-typeahead.min.css') ?>" type="text/css" rel="stylesheet"> 
...
<!-- timepicker -->
<link href="<?php echo base_url('assets/css/jquery.simple-dtpicker.css') ?>" rel="stylesheet" type="text/css"/>
<!-- datatable -->
