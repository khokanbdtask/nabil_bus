...
<?php if($this->uri->segment(2) !=='User'){?>
        ...
        ************************************* -->
        ...
        if(isset($HmvcMenu) && $HmvcMenu!=null && count($HmvcMenu) > 0)
    ...
    <!--     <li class="treeview <?php echo (($this->uri->segment(2)=="module")?"active":null) ?>">
        ...
        <li class="treeview <?php echo (($this->uri->segment(2)=="setting")?"active":null) ?>">
         ...
         <li class="treeview <?php echo (($this->uri->segment(2)=="rest_api")?"active":null) ?>">
            <a href="#">
                <i class="fa fa-wifi"></i><span><?php echo display('rest_api_settings')?></span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <li><a href="<?php echo base_url('dashboard/rest_api/form') ?>"><?php echo display('add_secret_key')?></a></li>
                <li><a href="<?php echo base_url('dashboard/rest_api/index') ?>"><?php echo display('secret_key_list')?></a></li> 
            </ul>
        </li>
