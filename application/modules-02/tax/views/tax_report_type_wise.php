...
<?php echo form_open('tax_report_type_wise', array('class' => 'form-inline', 'method' => 'get')) ?>
<?php
$today = date('Y-m-d');
?>
...
<div class="form-group">
 ...
 <div class="form-group">
    <label class="" for="to_date"><?php echo display('tax_type'); ?></label>

    <?php 
    echo form_dropdown('tax_settings_id', $tax_settings_dropdown,'', 'id="tax_settings_id" class="form-control"') 
    ?>
</div> 
...
<table class="table table-bordered">
    <thead>
        <tr>
            ...
            <th class="text-center"><?php echo display('tax_type').'/'.display('service_id') ?></th>
