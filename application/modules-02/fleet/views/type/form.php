        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <a href="<?php
                        $fleet_facilities_list = null ;
                        echo base_url('fleet/fleet_type/index') ?>" class="btn btn-sm btn-success" title="List"><i class="fa fa-list"></i> <?php echo display('list') ?></a>
            ...
            <div class="panel-body">
                ...
                <?= form_open('fleet/fleet_type/form/') ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                        <select id="layout" name="layout" required="required" class="form-control layout">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input name="total_seat" class="form-control" min="2"  type="number" placeholder="<?php echo display('total_seat') ?>" id="seat" value="<?php echo $fleet_type->total_seat ?>" onkeyup="myFunction()">
                        </div>
                    </div> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <span class="text-danger help-text"><?php echo display('seat_number_textarea') ?>
                            </span>
                        </div>
                    </div></div>
                ...
                <table id="layoutimg">
                      <?php $total_s = $fleet_type->total_seat;
                       ...
                       <td>
                        <?php
                        if($i == round($total_s/4) && $fleet_type->lastseat == "last"){ ?>
                                <?php echo "<img class='img' width='50px' height='50px' src='../../assets/img/f2dcc1cda37a23d4dd30125ebf2ac6ae.png' onerror=this.src='../../../assets/img/f2dcc1cda37a23d4dd30125ebf2ac6ae.png' title='' />";
                              ?>
                                <?php  }else{?>
            ...
            <div class="form-group row">
                <label for="total_weight" class="col-sm-3 col-form-label"><?php echo display('total_weight') ?></label>
                <div class="col-sm-4">
                    <input name="total_weight" class="form-control" type="number" min="0" placeholder="<?php echo display('total_weight') ?>" id="weight" value="<?php echo (isset($fleet_type->total_weight))?$fleet_type->total_weight:'' ?>" >
                    <small>
                        <?php echo display('total_weight_mean'); ?>
                    </small>
                </div>
            </div>

            <div class="form-group row">
                <label for="luggage_service" class="col-sm-3 col-form-label"><?php echo display('luggage_service'); ?>
                 *</label>
                <div class="col-sm-9">
                    <label class="radio-inline">
                        <?php echo form_radio('luggage_service', '1', ((isset($fleet_type->luggage_service) && $fleet_type->luggage_service==1)?1:1), 'id="luggage_service"'); ?> Active
                    </label>
                    <label class="radio-inline">
                        <?php echo form_radio('luggage_service', '0', ((isset($fleet_type->luggage_service)&&$fleet_type->luggage_service=="0")?1:0) , 'id="luggage_service"'); ?> Inactive
                    </label>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <?php  }}?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <label class="radio-inline">
                                <?php echo form_radio('status', '1', (($fleet_type->status==1)?1:1), 'id="status"'); ?>Active
                            </label>
                            <label class="radio-inline">
