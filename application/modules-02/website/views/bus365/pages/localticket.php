                ...
                <div class="ticket-content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <tbody>
                                <tr>
                                    <td><strong><?php echo display('pickup_location'); ?>:</strong> <?php echo (!empty($pickup)?$pickup:null) ?></td>
                                    <td><strong><?php echo display('drop_location'); ?>:</strong> <?php echo (!empty($drop)?$drop:null) ?></td>
                                    <td><strong>Date:</strong> <?php echo (!empty($ticket->date)?date("d-F-Y h:i:s A",strtotime($ticket->date)):null) ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                 ...
                 <div class="ticket-content" style="margin-top:20px">
                    ...
                    <span><?php echo display('amount'); ?> : 
                        <strong><?php $st = $ticket->payment_status;
                        if($st = 1){
                        echo 'Pending';
                        }else{
                            echo 'Paid';
