       ...
       $('#paypal_id').prop('disabled', true);
          ...
          $('#bank_id').prop('disabled', true);
           $('#payu_id').prop('disabled', true);
            ...
            <?php echo form_open('https://pay.ozow.com', array( 'id'=>'ozow')); ?>
            ...
            <button type="submit" id="ozow" class=" mt-2 btn btn-block btn-light"><img src="https://ozow.com/wp-content/uploads/2021/08/Ozow-Logo.png" class="img-responsive img-fluid" width="70px"></button>
            <?php echo form_close(); ?>
