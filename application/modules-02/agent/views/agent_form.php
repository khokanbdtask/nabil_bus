                            ...
                            <?php $sl = 1; ?>
                                <?php foreach ($agen as $query) { ?>
                                    <tr>
                                        ...
                                        <a href="<?php echo base_url("agent/agent_controller/agent_ledger_new/$query->agent_id") ?>"><?php echo $query->agent_first_name.' '.$query->agent_second_name; ?></a>    
                                        </td>
                                        <td>
                                        ...
                                        <td> 
                                            ...
                                            <!-- <a href="<?php echo base_url("agent/agent_controller/agent_ledger_new/$query->agent_id") ?>" class="btn btn-xs btn-info" ><i class="fa fa-print"></i></a> -->
                                            <!-- New code 2021 direct update  -->
                                        </td>
                                    </tr>
                                    <?php $sl++; ?>
                                ...
                                <?= form_open_multipart('agent/agent_controller/create_agent') ?>
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                          ...
                                          <div class="col-sm-4">
                                            <input name="agent_commission" class="form-control" type="text" placeholder="<?php echo display('agent_commission'); ?>" id="agent_commission" required>
                                        </div>
                                    ...
                                    <!-- New code 2021 direct update  -->
                                        <div for="agent_commission" class="col-sm-2 col-form-div">
                                          ...
                                          <div class="col-sm-4">
                                            <select name="locationid" class="form-control" style="width: 100%">
                                                    <option value="">Select Country</option>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12"><h3><?php echo display('login_info')?></h3></div>
                                        <div for="log_email" class="col-sm-2 col-form-div">
                                            <?php echo display('email') ?>
                                        </div>
                                        <div class="col-sm-4">
                                            <input name="log_email" class="form-control" type="text" placeholder="<?php echo display('email') ?>" id="log_email" readonly>

                                        </div>
                                        <div for="password" class="col-sm-2 col-form-div">
                                            <?php echo display('password') ?>
                                        </div>
                                        <div class="col-sm-4">
                                            <input name="password" class="form-control" type="text" placeholder="<?php echo display('password') ?>" id="password" required>
                                        </div>
...
<script type="text/javascript">
   ...
   document.getElementById('log_email').value=data;
    }
</script>