        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <a href="<?php echo base_url('luggage_nitol/terms/terms_and_condition_form') ?>"
                           class="btn btn-sm btn-info" title="Add"><i
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($this->permission->method('luggage', 'update')->access()): ?>
                                        <a href="<?php echo base_url("luggage_nitol/terms/terms_and_condition_form/$term->id") ?>"
