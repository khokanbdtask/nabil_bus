        ...
        <div class="panel panel-bd">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <label><?php echo display('purchase_key') ?> <span class="glyphicon glyphicon-question-sign"
                                                                           data-toggle="tooltip" data-placement="bottom"
                                                                           title="Enter Envato purchase key or Bdtask purchase key"></span></label>
                        <input type="text" name="purchase_key" placeholder="<?php echo display('purchase_key') ?>"
                    ...
                    <div class="col-sm-6 themeupload">
                        <div class="pull-left overwrite">
                            <input type="checkbox" name="overwrite" value="false" id="overwrite"> <label
                                    for="overwrite"><?php echo display("overwrite") ?></label>
                        </div>
                        ...
                        foreach ($live_modules as $livemod) {
                            ...
                            if (!in_array($livemod->identity, $downloaded)) {
                                ...
                                <div class="col-md-4 addonsbox">
                                    <div class="thumbnail">
                                        <div class="addon_img">
                                            <img src="<?php echo(!empty($livemod->thumb) ? $livemod->thumb : NO_IMAGE) ?>"
                                                 alt="" class="mod_thumb_img">
                                        </div>
                                        <div class="caption">
                                            <h3>
                                                <span class="addon_title"> <?php echo html_escape($livemod->module_name); ?></span>

                                                <span class="price addon_price">$<?php echo number_format($livemod->price, 2); ?></span>

                                            </h3>
                                            <p class="caption_desc"></p>
                                            <p>
                                                <a href="<?php echo $livemod->payment_url; ?>" target="_blank"
                                                   role="button"
                                                   class="btn btn-success"><?php echo display('buy_now') ?></a>
                                            </p>
...
//                    exit();
                    ...
                    //////////List down all default module in $def_mods /////////////////////////

                    $def_mods = ['dashboard', 'template', 'addon', 'account', 'agent', 'enquiry', 'fitness', 'fleet', 'hr', 'price', 'reports', 'template', 'ticket', 'trip', 'website'];
                    if (is_array($map))
                            ...
                            if ($value != "index.html" && !in_array($mod, $def_mods)) {
                                ...
                                if (file_exists($file) && file_exists($db) && file_exists($image)) {
                                    ...
                                    if (isset($HmvcConfig[$mod])
                                        ...
                                        //form to module
                                        if ($livemod->app_type == 'web') {
                                            echo form_open('addon/module/install');
                                        } else {
                                            echo form_open($livemod->identity . '/Apk_controller/apk_qr/' . $livemod->identity);
                                        }
                                            ...
                                            <div class="thumbnail">
                                                ...
                                                <?php   }
                                                        else
                                                        {
                                                            ...
                                                            <?php if ($livemod->app_type == 'web') { ?>
                                                                <button onclick="return confirm('<?php echo display("are_you_sure") ?>')"
                                                                        type="submit" class="btn btn-success"
                                                                        role="button">
                                                                    <?php echo display("install") ?>
                                                                </button>
                                                            <?php } else {
                                                                $qr = $livemod->module_name . '/module/upload/';
                                                                ?>

                                                                <button type="submit" class="btn btn-success" role="button"><?php echo display("download") ?></button>
                                                        <?php } ?>
                                                    <?php } ?>
                                    ...
                                    <div class="col-md-4  addonsbox">
                                        <div class="thumbnail">
                                            ...
                                            <p><a href="<?php echo base_url("addon/module/uninstall/$delMod/delete") ?>"
                                                  type="submit"
