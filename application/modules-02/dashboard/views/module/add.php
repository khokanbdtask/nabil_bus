        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <a href="<?php echo base_url('dashboard/module/index') ?>" class="btn btn-sm btn-success" title="List"> <i class="fa fa-list"></i> <?php echo display('list') ?></a> 
                        <?php 
                        // if($module->id): 
                            ?>
                        <a href="<?php echo base_url('dashboard/module/form') ?>" class="btn btn-sm btn-info" title="Add"><i class="fa fa-plus"></i> <?php echo display('add') ?></a> 
                        <?php 
                    // endif; 
                    ?> 
                    </h4>
                                ...
                                <div class="thumbnail">
                                  ...
                                  <div class="caption">
                                    ...
                                    <p>
                                        ...
                                        <?php } else { ?>
                                            <button onclick="return confirm('<?php echo display("are_you_sure") ?>')" type="submit" class="btn btn-success" role="button" disabled="disabled"><?php echo display("install") ?></button>  
                                        <?php } ?>
                                        <a onclick="return confirm('<?php echo display("are_you_sure") ?>')" href="<?php echo base_url("dashboard/module/uninstall/$delMod/delete") ?>" type="submit" class="btn btn-danger" disabled="disabled"><?php echo display("delete") ?></a>
                                    </p>
                                  </div>
                                </div>
                            </div>
