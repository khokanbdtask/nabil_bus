            ...
            <div class="panel-body">
                ...
                <?php echo form_open_multipart('dashboard/setting/create','class="form-inner"') ?>
                   ...
                   <!-- New code 2021 direct update  -->
                    ...
                    <div class="form-group row">
                        <label for="text_logo" class="col-xs-3 col-form-label"><?php echo display('text_logo') ?></label>
                        <div class="col-xs-9">
                            <input name="text_logo" type="text" class="form-control" id="text_logo" placeholder="<?php echo display('text_logo') ?>"  value="<?php echo empty($setting->text_logo) ? null : $setting->text_logo?>" >
                        </div>
                    </div>
                    <!-- New code 2021 direct update  -->
