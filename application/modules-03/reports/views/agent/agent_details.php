        ...
        <div class="panel panel-bd">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <?php echo display('agent_report') ?> <a href="#" class="btn btn-sm btn-danger" title="Print"
                            onclick="printContent('PrintMe')"><i class="fa fa-print"></i></a>
                    </h4>
                </div>
            </div>
            <div class="panel-body">
                <div class="col-sm-12" style="margin-bottom:20px">
                    ...
                    <div class="form-group" id="agnt">
                        <label for="agent_id"
                            class="col-sm-2 control-label"><?php echo display('select_agent_name') ?></label>
                        <div class="col-sm-10">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <input name="end_date" id="end_date" type="text"
                                        placeholder="<?php echo display('end_date') ?>" class="form-control datepicker"
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input name="booking_type[]" id="ticket_booking" type="checkbox" class="form-control "
                                    value="1">
                            </div>
                            ...
                            <div class="col-sm-3">
                                ...
                                <input name="booking_type[]" id="luggage_booking" type="checkbox" class="form-control "
                                    value="2">
                            </div>
                            <div class="col-sm-3">
                                <button type="submit"
                                    class="form-control btn btn-success"><?php echo display('search') ?></button>
                            </div>
                        </div>
                    </div>
                    <?php echo form_close() ?>
    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd">
            ...
            <div class="panel-body" id="PrintMe">
                ...
                <!-- New code 2021 for show all option in dropdown -->
                ...
                <?php elseif (!empty($detls->agent_first_name)): ?>
        ...
        ?>
                        <tr style="background-color:<?php echo ($query->tkt_refund_id != '' ? '#F2D7D5' : '') ?>;">
                            ...
                            <td>
                                ...
                                <a
                                    href="<?php echo ($b_type == "ticket") ? base_url("ticket/booking/view/$query->booking_id") : base_url("luggage_nitol/luggage/view/$query->booking_id") ?>">
...
if ($query->tkt_refund_id != '') {echo 'Refunded';} else {
            echo $currency . ' ' . $query->credit;}?></td>
                            <td class="text-right">
                                <?php if ($query->tkt_refund_id != '') {echo 0;} else {echo $query->commission_rate;}?>
                            </td>
                        </tr>
                        <?php $sl++;?>
                        <?php }?>
...
if (!empty($agenL)) {
  ...
  <?php
    ...
    $total_ticket += count($agenL);
    foreach ($agenL as $query) {
        if ($query->tkt_refund_id != '') {
            $total_price += 0;
            $total_commission += 0 * $query->commission_rate / 100;
        } else {
                            ...
                            <?php
                                if ($query->tkt_refund_id != '')
                                 {echo 'Refunded';} 
                                    ...
                                    // echo $currency . ' ' . $query->total_price * $query->commission_rate / 100;
                                    echo $currency . ' ' . $query->credit;
                                    }
                                    ?>
...
<!-- New code for test 2021 -->
                    ...
                    <tfooter>
                        <tr>
                            ...
                            <td class="text-right"><b><?php echo $currency; ?> <?php echo $total_price; ?></b></td>
                            <td class="text-right"><b><?php echo $currency; ?> <?php echo $total_commission; ?></b></td>
                            <td></td>
                        </tr>
                    </tfooter>
