        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <a href="<?php echo base_url('luggage_nitol/luggage/form') ?>" class="btn btn-sm btn-info" title="Add"><i
            ...
            <div class="panel-body">
                ...
                <div class="">
                    <table class="unpaidluggage table table-bordered ">
                        <thead>
                        <tr>
                        ...
                        <?php foreach ($bookings as $booking) {
                            ...
                            <tr class="<?php echo(!empty($booking->luggage_refund_id) ? "bg-danger" : null) ?>">
                                <td><?php echo $sl++; ?></td>
                                ...
                                <td><?php
                                    ...
                                    if ($booking->payment_status == 2 || $booking->payment_status == 1) {
                                        if ($this->permission->method('luggage', 'update')->access()):
