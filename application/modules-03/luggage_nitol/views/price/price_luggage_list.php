<div class="form-group text-right">
    <?php if($this->permission->method('price', 'create')->access()): ?>
        <a href="<?php echo base_url('luggage_nitol/packages/create_price'); ?>"><button type="button" class="btn btn-primary btn-md">
                                ...
                                <?php foreach ($prices as $query) { ?>
                                    <tr class="<?php echo ($sl & 1)?" odd gradeX ":"even gradeC " ?>">
                                        ...
                                        <td class="center">
                                            ...
                                            <a href="<?php echo base_url("luggage_nitol/packages/price_luggage_view/$query->package_id") ?>" class="btn btn-xs btn-default"><i class="fa fa-eye"></i></a>
                                            <?php endif; ?>


                                            <?php if($this->permission->method('price', 'update')->access()): ?>
                                            <a href="<?php echo base_url("luggage_nitol/packages/price_update/$query->package_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a>
                                            <?php endif; ?>


                                            <?php if($this->permission->method('price', 'delete')->access()): ?>
                                            <a href="<?php echo base_url("luggage_nitol/packages/price_delete/$query->package_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-times" aria-hidden="true"></i>
                                            </a> 
                                            <?php endif; ?>
                                        </td>
                                    </tr>
