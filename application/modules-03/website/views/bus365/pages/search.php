                            ...
                            <div class="col-xs-12 col-sm-3 col-md-2">
                                <div class="form-group">
                                    <input type='text' name="date" class='form-control datepicker'
                                           ...
                                           value="<?php echo $search->date ?>" autocomplete="off">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="starting-price">
                                        <div class="price"><?php echo $appSetting->currency ?><?php echo $trip->price ?></div>
                                    </div>
                                </td>
                                <td>
                                    <div class="starting-price">
                                        <div class="price"><?php echo $appSetting->currency ?><?php echo $trip->children_price ?></div>
                                    </div>
                                </td>
                                <td data-label="Fare">
                                    <div class="starting-price">
                                        <div class="price"><?php echo $appSetting->currency ?><?php echo $trip->special_price ?></div>
                                    </div>
                                </td>
                                <td data-label="Operator">
                                    <div class="seat-view">
                                        ...
                                        <form action="<?php echo base_url("website/ticket_booking/findBookingInformation")?>" method="POST">

                                            <input type="hidden" name="trip_route_id" value="<?php echo $trip->route ?>">                                            <input type="hidden" name="trip_route_id" value="<?php echo $trip->route ?>">
                                            <input type="hidden" name="trip_id_no" value="<?php echo $trip->trip_id_no ?>">
                                            <input type="hidden" name="fleet_type_id" value="<?php echo $trip->type ?>">
                                            <input type="hidden" name="booking_date" value="<?php echo $b_date ?>">


                                            <button type="submit" class="btn btn-info">
                                                <!-- <?php echo display('book') . "1" ?> -->
                                                Book Now
                                            </button>
                                        ...
                                        <div class="seat-number">
                                            <?php
                                                ...
                                                $result = $CI->website_model->total_book_seat($trip->route,$trip->trip_id_no,$b_date);

                                                
                                                // client 2022 project update
                                                $freezeSeat  = $this->db->select("*")->from('freeze_seat')->where('tripid',$trip->trip_id_no)->where('status',1)->get()->num_rows();
                                                
                                               
                                                
                                            if (($trip->fleet_seats) > 0)
                                                echo (($trip->fleet_seats - $bookingResult[$c]) -  $result - $freezeSeat) . ' ' . display('seats_available');
                ...
                <div class="row">
                    <div class="col-sm-5 col-xs-12">
                        ...
                        <div class="price-details">
                            <a style="background-color:#0b2a5b;color:white;text-decoration: none;"
                               href="<?php echo base_url('website/website/how_to_use') ?>" class="btn btn-block"
                               onclick="window.open(this.href, '_blank'); return false;"><h4
                                        style="color:white"><?php echo display('how_to_use'); ?></h4></a>
                    ...
                    <div class="col-sm-7 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <input name="offer_code" id="offerCode" class="form-control"
                                   placeholder="<?php echo display('offer_code') ?>" autocomplete="off"/>
                        </div>
                        <div class="form-group">
                            <label for="child_no"><?php echo display('children') ?></label>
                            <input name="child_no" id="child_no" class="form-control seatno"
                                   placeholder="<?php echo display('child_no') ?>" autocomplete="off"/>
                        </div>
                        <div class="form-group">
                            <label for="adult"><?php echo display('adult') ?></label>
                            <input name="adult" id="adult" class="form-control seatno"
                                   placeholder="<?php echo display('adult') ?>" autocomplete="off"/>
                        </div>
                        <div class="form-group">
                            <label for="special"><?php echo display('special') ?></label>
                            <input name="special" id="special" class="form-control seatno"
                                   placeholder="<?php echo display('special') ?>" autocomplete="off"/>
