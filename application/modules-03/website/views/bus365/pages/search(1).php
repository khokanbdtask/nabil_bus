...
<section class="tour-inner">
    <div class="container">
        <div class="row tour-content">
          ...
          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal"  data-trip-route-id="<?php echo $trip->route ?>" data-trip-id-no="<?php echo $trip->trip_id_no ?>" data-fleet-registration-id="<?php // echo $trip->fleet_registration_id ?>" data-fleet-type-id="<?php echo $trip->type ?>" data-booking-date="<?php echo $b_date ?>" >
                                        <?php echo display('book') ?>
          </button>
