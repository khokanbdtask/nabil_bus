    ...
    <span style=" float:right;">
        <ul class="nav navbar-nav">
            ...
            <li>
                ...
                <a href="<?php echo base_url('website/User/upform_pasenger/') . $this->session->userdata('id_no'); ?>"
                   class="btn btn-sm profile_btn" title="Edit">
                    <?php echo display('profile'); ?> 
                </a> 
            </li>
            <li class="dropdown dropdown-user">
            <a href="#" class="dropdown-toggle setting_icon" data-toggle="dropdown"
               style="color: white;"><span><?php echo $this->session->userdata('firstname') ?></span></a>
                        ...
                        <?php foreach ($details as $booking) {
                            ...
                            <tr class="<?php echo(!empty($booking->tkt_refund_id) ? "bg-danger" : null) ?>">
                                ...
                                <td>
                                    ...
                                    <?php } ?>
                                    <a href="<?php echo base_url("website/User/view/$booking->id_no") ?>"
                                    ...
                                    <?php if ($booking->payment_status == 1) { ?>
                                        ...
                                        <a href="<?php echo base_url("website/User/delete_booking/$booking->id") ?>"
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    <label for="id_no"
                                           class="col-sm-3 col-form-label"> <?php echo display('booking_id') ?>
                                    </label>
                                    <div class="col-sm-9">
                                        <input type="text" name="booking_id" value="" id="bookid" class="form-control"
                                               readonly="readonly">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="id_no"
                                           class="col-sm-3 col-form-label"><?php echo display('transaction_no') ?>
                                        *</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="id_no"
                                           class="col-sm-3 col-form-label"> <?php echo display('payer_name') ?>
                                    </label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="id_no"
                                           class="col-sm-3 col-form-label"><?php echo display('account_num') ?>
                                        * </label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="id_no"
                                           class="col-sm-3 col-form-label"><?php echo display('bank_name') ?>
                                    </label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group text-center">
                                    <button type="button" class="btn btn-danger w-md m-b-5"
                                            data-dismiss="modal"><?php echo display('deny') ?></button>
