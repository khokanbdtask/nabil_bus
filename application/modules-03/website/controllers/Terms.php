...
class Terms extends MX_Controller
{
  ...
  public function terms_and_condition_form($id = null)
 {
  ...
  $this->permission->method('website','create')->redirect();
  ...
  if ($this->form_validation->run()) { 
   ...
   if (empty($postData['id'])) {
    ...
    redirect("website/terms/terms_and_condition_form"); 

   } else {

    $this->permission->method('website','update')->redirect();
    ...
    redirect("website/terms/terms_and_condition_form/".$postData['id']);  
   }
