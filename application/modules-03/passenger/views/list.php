    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <div class="">
                    <table class="passagerlist table table-bordered table-hover">
                        <thead>
                        <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($this->permission->method('luggage', 'read')->access()): ?>
                                        <a href="<?php echo base_url("passenger/view/$passenger->id") ?>"
                                           class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left"
                                           title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                    <?php endif; ?>

                                    <?php if ($this->permission->method('luggage', 'update')->access()): ?>
                                        <a href="<?php echo base_url("passenger/form/$passenger->id") ?>"
                                    ...
                                    <?php if ($this->permission->method('luggage', 'delete')->access()): ?>
                                        <a href="<?php echo base_url("passenger/delete/$passenger->id") ?>"
