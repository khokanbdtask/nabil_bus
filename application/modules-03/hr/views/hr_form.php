        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input name="document_id" class="form-control" type="text"
                               placeholder="<?php echo display('document_id') ?>" id="document_id">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div for="address_line_1"
                         class="col-sm-2 col-form-div"><?php echo display('address_line_1') ?> </div>
                    <div class="col-sm-10">
                        <textarea name="address_line_1" class="form-control"
                                  placeholder="<?php echo display('address_line_1') ?>" id="address_line_1"></textarea>
                    </div>

                </div>
                <div class="form-group row">

                    <div for="address_line_2"
                         class="col-sm-2 col-form-div"><?php echo display('address_line_2') ?> </div>
                    <div class="col-sm-10">
                        <textarea name="address_line_2" class="form-control"
                                  placeholder="<?php echo display('address_line_2') ?>" id="address_line_2"></textarea>
                    </div>
