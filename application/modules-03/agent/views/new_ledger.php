                             ...
                             foreach ($ledger as $query) {
                              ...
                              ?>
                               <tr>
                                    ...
                                    <?php if (substr($query->booking_id, 0, 1) == "B") : ?>
                                       <a href="<?php echo base_url("ticket/booking/view/$query->booking_id") ?>"> <?php echo $query->booking_id; ?> </a>
                                       
                                          
                                    <?php elseif(substr($query->booking_id, 0, 1) == "L") : ?>

                                        <a href="<?php echo base_url("luggage_nitol/luggage/view/$query->booking_id")?>"> <?php echo $query->booking_id; ?> </a>
                                    <?php else: ?>
