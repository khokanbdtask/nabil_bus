                    ...
                    <?= form_open_multipart('agent/agent_controller/agent_update/'. $data->agent_id) ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="hidden" name="old_email" value="<?php echo $data->agent_email;?>">
                            </div>
                            <label for="agent_address_line_1" class="col-sm-2 col-form-label">
                                <?php echo display('agent_address_line_1') ?> </label>
                            <div class="col-sm-4">
                                <textarea name="agent_address_line_1" class="form-control" placeholder="<?php echo display('agent_address_line_1') ?>" id="agent_address_line_1"><?php echo $data->agent_address_line_1;?>
                                </textarea>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <textarea name="agent_address_line_2" class="form-control" placeholder="<?php echo display('agent_address_line_2') ?>" id="agent_address_line_2"><?php echo $data->agent_address_line_2;?>
                                </textarea>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <select name="agent_country" class="form-control" style="width: 100%">
                                    <option value="<?php echo $data->agent_country;?>"><?php echo $bb['agent_country'];?>
                                    </option>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                                          <label for="agent_commission" class="col-sm-2 col-form-label">
                                            <?php echo display('agent_commission'); ?>%
                                        </label>
                                          <div class="col-sm-4">
                                            <input name="agent_commission" class="form-control" type="text" placeholder="<?php echo display('agent_commission'); ?>" id="agent_commission" value="<?php echo $data->agent_commission;?>">
                                        </div>
                                         ...
                                         <!-- New code 2021 direct update  -->
                                            ...
                                            <select name="locationid" class="form-control" style="width: 100%">
                                                        ...
                                                        <?php foreach ($location as $value): ?>
                                                            <?php if ($value->id == $data->locationid): ?>
