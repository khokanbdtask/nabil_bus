                ...
                <div class="panel panel-bd">
                    <div class="panel-heading">
                        <div class="panel-title box-header">
                            ...
                            <div>
                                <a href="<?php echo base_url('addon/theme/download_theme') ?>"
                                   class="btn btn-success"><i
                                            class="ti-download"> </i> <?php echo display('download') ?></a>
                            </div>
                        </div>
                    </div>
...
<!--                            <div class="col-sm-3">-->
<!--                                <label>--><?php //echo display('purchase_key') ?><!-- <span-->
<!--                                            class="glyphicon glyphicon-question-sign" data-toggle="tooltip"-->
<!--                                            data-placement="bottom"-->
<!--                                            title="Enter Envato purchase key or Bdtask purchase key"></span></label>-->
<!--                                <input type="text" name="purchase_key"-->
<!--                                       placeholder="--><?php //echo display('purchase_key') ?><!--" class="form-control"-->
<!--                                       required/>-->
<!--                            </div>-->
                            <div class="col-sm-3">
                                <label><?php echo display('theme_name') ?></label>
                                <input type="text" name="theme_name" placeholder="<?php echo display('theme_name') ?>"
                            ...
                            <div class="col-sm-3">
                                <input type="submit" value="<?php echo display('upload') ?>" name="upload_theme"
                                       class="btn btn-primary themeupload">
                            </div>
                            <?php echo form_close(); ?>
                        </div>
                        <hr/>
                                            ...
                                            <div class="card_item">
                                                <div class="img_part">
                                                    ...
                                                    <img class="img-fluid img-thumbnail"
                                                         src="<?php echo(!empty($theme_img) ? $theme_img : NO_IMAGE) ?>"
                                                         alt="<?php echo html_escape($theme->theme_name) ?>">
                                                    <a href="<?php echo $theme->payment_url; ?>" target="_blank"
                                                       role="button"
                                                       class="btn btn-dtls"><?php echo display('buy_now') ?></a>
                                ...
                                <div class="col-md-4 themebox  theme_<?php echo $single_theme->name ?>">
                                    <div class="card_item">
                                        <div class="img_part">
                                            ...
                                            <img class="img-fluid img-thumbnail"
                                                 src="<?php echo base_url() . 'application/modules/website/assets/images/bus365.png'; ?>"
                                                 alt="<?php echo html_escape($single_theme->name); ?>">
                                            <?php if (@$active_theme == $single_theme->name) { ?>
                                                <a href="<?= base_url()."website" ?>" target='__blank'
                                                   class="btn btn-dtls">Theme Details</a>
                                            <?php } else { ?>
                                                <a href="<?php echo base_url('addon/Theme/active_theme/' . html_escape($single_theme->name)) ?>"
                                                   target='__blank'
                                                   class="btn btn-dtls"><?php echo display('active') ?></a>
                                            <?php } ?>
                                        ...
                                        <div class="caption_part">
                                            ...
                                            <div class="caption_btn <?php echo((@$active_theme == $single_theme->name) ? 'activated' : ''); ?>">
                                                <?php if (@$active_theme !== $single_theme->name) { ?>
                                                    <a href="<?php echo base_url('addon/theme/active_theme/' . html_escape($single_theme->name)) ?>"
                                                       class="btn btn-success"><?php echo display('active') ?></a>
                                                    <button data_id="<?php echo $single_theme->name; ?>"
                                                            class="btn btn-danger delete_item"><?php echo display("delete") ?></button>

                                                <?php } else { ?>
                                                    <a href="<?php echo base_url().($single_theme->name)?$single_theme->name:'' ?>" target='__blank'
