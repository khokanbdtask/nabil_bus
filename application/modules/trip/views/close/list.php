        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <a href="<?php echo base_url('trip/assign/index') ?>" class="btn btn-sm btn-info" title="Add"><i
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($this->permission->method('fleet', 'read')->access()): ?>
                                        <a href="<?php echo base_url("trip/close/view/$close->id_no") ?>"
                                    ...
                                    <?php if ($this->permission->method('fleet', 'update')->access()): ?>
                                        <a href="<?php echo base_url("trip/close/form/$close->id") ?>"
