    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    <label for="stoppage_points"
                           class="col-sm-3 col-form-label"><?php echo display('stoppage_points') ?>* </label>
                    <div class="col-sm-9">
                        <input name="stoppage_points" class="form-control tokenfield" type="text"
                               placeholder="<?php echo display('stoppage_points') ?>" id="stoppage_points"
                               value="<?php echo $route->stoppage_points ?>" onclick="showDiv()" required>
                        <ul class="answer_list" id="stopagediv"
                            style="display:none;height: auto;list-style-type: none;height:100px;overflow-y: auto;width: 200px">


                            <input type="hidden" name="proId" id="proId">
                        </ul>
                        <ul class="answer_list" id="stopagediv2"
                            style="height: auto;list-style-type: none;height:100px;overflow-y: auto;width: 200px">
                            <?php
                            $html = "";
                            $data = $this->db->select("*")
                                ->from('trip_location')
