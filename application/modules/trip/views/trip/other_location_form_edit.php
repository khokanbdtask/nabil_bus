    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?= form_open('trip/trip/upDateOtherLocation/'.$otherlocation->id) ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="number" class="form-control trips_info" name="extra_fee" value="<?php echo $otherlocation->extra_fee ?>" required>
