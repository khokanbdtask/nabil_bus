                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-6 col-md-offset-2">
                            ...
                            <div id="purchase_key_box" class="form-group has-success">
                                ...
                                <input type="text" class="form-control form-control-success" id="purchase_key" placeholder="Enter your purchase key" value="BDT-85CF219-C99FC--0353ED4742903">
                                <div class="form-feedback">Success! Almost done it.</div>
                                <small class="text-muted">You've got a purchase key after purchasing the item</small>
                                <br>
                                <input type="hidden" name="itemtype" id="itemtype" value="module">
                              
                            </div>
                            <div class="form-group">
                                <a href="<?php echo base_url('addon/module/index'); ?>" class="btn btn-danger" data-dismiss="modal">Cancel</a>
                        ...
                        <div class="row waitmsg none">
                            <div class="col-md-12">
                                <h3 class="text-center">Downloading... Please wait for <span id="wait"> 15</span> Seconds.</h3>
                            </div> 
                        </div>
