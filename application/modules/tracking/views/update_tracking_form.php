<div class="form-group text-right">
    <a href="<?php echo base_url();?>/tracking/Tracking_controller/create_tracking" class="btn btn-primary"><i class='fa fa-gift' aria-hidden='true'></i> <?php echo display('tracking_list') ?></a>
</div>
<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?= form_open('tracking/Tracking_controller/tracking_update/'. $data->tracking_id) ?>
