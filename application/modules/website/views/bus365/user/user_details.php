...
<span style=" float:right;">
        ...
        <ul class="nav navbar-nav">
            ...
            <li>
                ...
                <a href="<?php echo base_url('website/User/upform_pasenger/').$this->session->userdata('id_no');  ?>" class="btn btn-sm profile_btn" title="Edit">
                    <?php echo display('profile'); ?> 
                </a> 
            </li>
            <li class="dropdown dropdown-user">
            <a href="#" class="dropdown-toggle setting_icon" data-toggle="dropdown" style="color: white;"><span><?php echo $this->session->userdata('firstname') ?></span></a>
        ...
        <div class="panel lobidrag">
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <h4> 
                    <?php  
                    // $stus=$this->db->select('*')->from('bank_transaction')->where('booking_id',$booking->id_no)->get()->row();
            ...
            <div class="panel-body">
                        ...
                        <tbody>
                           ...
                           $rd=$this->db->select('*')->from('trip_route')->where('id',$booking->trip_route_id)->get()->row();
                                ...
                                if($booking->payment_status == 1){
                                    ...
                                    elseif($booking->payment_status == "NULL")
                                    {
                                        echo 'Paid';
                                    }
                ...
                <!-- <div class="mt-5 mb-5">
                    <table class="datatable2 table table-bordered ">
                        <h4 class="text-center">Luggage booking</h4>
                        <thead>
                            <tr>
                                <th><?php echo display('sl_no') ?></th>
                                <th><?php echo display('booking_date') ?></th>
                        ...
                        <tbody>
                            ...
                            <?php $sl = 1; ?>
                            <?php foreach ($luggage as $booking) { 
                            ...
                            <tr class="">
                                <td><?php echo $sl++; ?></td>
                                <td><?php echo $booking->date; ?></td>
                                <td><?php echo $booking->luggage_booking_id; ?></td>
                                <td>
                                    <?php $result=$this->db->select('firstname,lastname')->from('tkt_passenger')->where('id_no',$booking->sender_id)->get()->result();
                                 foreach ($result as $name) {
                                    echo $name->firstname.' '.$name->lastname;
                                 }
                                 ?>
                                 ...
                                 <td>
                                    <?php $result=$this->db->select('firstname,lastname')->from('tkt_passenger')->where('id_no',$booking->receive_id)->get()->result();
                                 foreach ($result as $name) {
                                    echo $name->firstname.' '.$name->lastname;
                                 }
                                 ?>
                                ...
                                <td>
                                    <?php
                                    $rd=$this->db->select('*')->from('trip_location')->where('id',$booking->start_location)->get()->row();
                                    echo  $rd->name; ?>

                                 </td>
                                <td>
                                    <?php
                                    $rd=$this->db->select('*')->from('trip_location')->where('id',$booking->drop_location)->get()->row();
                                    echo  $rd->name; ?>
                               ...
                               <?php if($booking->payment_status == "partial"):?>
                                    ...
                                    <a href="<?php echo base_url("website/User/successPaymentPartial/$booking->luggage_booking_id") ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" title="View">Pay Now</a>
                                ...
                                <?= form_open('website/User/payment_confirm') ?>
                                    ...
                                    <div class="form-group row">
                                        <label for="id_no" class="col-sm-3 col-form-label"><?php echo display('transaction_no') ?>
                                          *</label>
                                        <div class="col-sm-9">
                                           <input type="text" name="tran_num" value=""  class="form-control" required="required">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                         ...
                                         * </label>
                                        <div class="col-sm-9">
                                           <input type="text" name="bank_acc" value=""  class="form-control" required="required">
                                        </div>
                                    </div>
                                     <div class="form-group row">
...
<!-- jQuery -->
<?php $this->load->view('template/includes/js') ?>
