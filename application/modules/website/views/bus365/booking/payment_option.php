...
<?php
$setting=$this->db->select('*')->from('ws_setting')->get()->result();
...
<div class="container">
<!--      <div id="outputPreviewm" class="alert hide" role="alert" >-->
...
<!--             <li class="active"><button type="button" class="btn btn-primary btn-md ">Registration</button></li>-->
             ...
             <li>
<!--                 <button type="button" class="btn btn-primary btn-md " data-target="#login_modal" data-toggle="modal">--><?php //echo display('login') ?><!--</button>-->
...
<?php echo form_open('website/search/checkout', array('class'=>'row', 'id'=>'checkoutFrms')); ?>
            ...
            <div id="home" class="tab-pane active">
               <div class="passenger-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <input name="firstname" class="form-control" type="text" placeholder="First Name" id="name" value="<?php echo $this->session->userdata('firstname'); ?>" required />
                            </div>
                            <div class="col-sm-6">
                                <input name="lastname" class="form-control" type="text" placeholder="Last Name" value="<?php echo $this->session->userdata('lastname'); ?>" id="lastname" required />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label><?php echo display('phone'); ?> *</label>
                        <input type="text" name="phone" value="<?php echo $this->session->userdata('phone'); ?>" required class="form-control" id="phone"  placeholder="Phone number" required />
                    </div>
                    <div class="form-group">
                        <label><?php echo display('email'); ?> *</label>
                        <input type="email" name="email" class="form-control" id="email" required placeholder="Email address"  value="<?php echo $this->session->userdata('p_email'); ?>" reqired />
                    </div>
                    <div class="form-group">
                        ...
                        <input type="hidden" name="old_password" class="form-control" id="old_password" placeholder="Your Password" value="<?php echo $this->session->userdata('p_password'); ?>" reqired />
                    </div>
                     <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="address_line_1" id="address" class="form-control" rows="3" placeholder="Address" required><?php echo $this->session->userdata('address'); ?></textarea>
                    </div>
    ...
    <div class="col-sm-7">
        <a style="background-color:#0b2a5b;color:white;text-decoration: none; display:none" href="<?php echo base_url('website/website/how_to_pay') ?>"  class="btn btn-block"  onclick="window.open(this.href, '_blank'); return false;"><h4 style="color:white"><?php echo display('how_to_pay');?></h4> </a>
        <div class="journey-details">
            ...
            <dl class="dl-horizontal">
                ...
                <dd>&nbsp;
                    <?php echo (!empty($pickup)?$pickup:null) ?>
                </dd>
                <dt><?php echo display('drop_location'); ?></dt>
                <dd>&nbsp;
                    <?php echo (!empty($drop)?$drop:null) ?>
                </dd>
