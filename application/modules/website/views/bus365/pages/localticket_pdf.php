                ...
                <div class="ticket-content">
                                ...
                                <tr>
                                    <td>
                                        <div class="ticket-logo">
                                            <img src="<?php echo base_url().$appSetting->logo; ?>" class="img-responsive" alt="<?php echo $appSetting->title; ?>">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <tbody>
                                <tr>
                                    <td><strong><?php echo display('pickup_location') ?>:</strong> <span><?php echo (!empty($pickup)?$pickup:null) ?></span></td>
                                    <td><strong><?php echo display('drop_location') ?>:</strong> <span><?php echo (!empty($drop)?$drop:null) ?></span></td>
                    ...
                    <div class="row">
                        ...
                        ?>
                                                <?php echo $price = (!empty($ticket->price)?$ticket->price:0) ?> 
                        <?php 
