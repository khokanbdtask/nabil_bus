        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
             ...
             <!-- New code 2021 direct update  -->
                ...
                <div class="table table-responsive" id="printTable">
                    <table class="journeylist table table-bordered ">
                        ...
                        <?php if (!empty($passengarlist)): ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $pvalue->emergency_name; ?></td>
                                <td><?php echo $pvalue->emergency_phone; ?></td>
                                ...
                                <td>
                                    <?php if ($pvalue->travel_status == 0): ?>
                                        <?php echo "pending" ?>
                                    <?php else: ?>
                                        Checked-in <?php echo $pvalue->chake_in_time; ?>
                                    <?php endif; ?> 
                                </td>
                                <!-- <?php echo base_url("ticket/booking/travel/$pvalue->customerbookingId") ?> -->
                                <!-- <?php echo base_url("ticket/booking/untravel/$pvalue->customerbookingId") ?> -->
                                <td>
                                    <?php if ($pvalue->travel_status == 0): ?>
                                        <a target="_blank" id="<?php echo $pvalue->customerbookingId ?>" data ="unchek"  class="changestatus btn btn-success btn-xs" data-toggle="tooltip" data-placement="left" title="travel">Check-in</a>
                                    <?php else: ?>
                                        <a target="_blank" id="<?php echo $pvalue->customerbookingId ?>" data ="check"  class="changestatus btn btn-default btn-xs" data-toggle="tooltip" data-placement="left" title="not travel">Check-out</a>
                                    <?php endif; ?> 
                                </td>
...
$( document ).ready(function() {
      ...
      var journeylist =  $('.journeylist').DataTable({


        responsive: false,
        paging: true,
        dom: "<'row'<'col-sm-8'lB><'col-sm-4'f>>tp",
        "lengthMenu": [[ 100, 150, 200, 500, -1], [ 100, 150, 200, 500, "All"]],
        buttons: [
    ...
    $(".changestatus").click(function(){
        ...
        $.ajax({
                    type:'post',
                    data : {"currentid" : currentid, "currentStatus" : currentStatus},
                    url: '<?php echo base_url("ticket/booking/travel") ?>',
                    success:function(return_data)
                    {
                        console.log(return_data);
                        location.reload();
                        // journeylist.ajax.reload(null,false);  
                        // journeylist.ajax.reload();  
