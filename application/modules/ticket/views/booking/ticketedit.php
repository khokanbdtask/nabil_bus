            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                 ...
                 <!-- client 2022 project update -->
                    <div class="form-group row">
                    <label for="rechedulefee" class="col-sm-3 col-form-label">Rescheduling Fee</label>
                    <div class="col-sm-9">
                        <input name="rechedulefee"   class="form-control"  type="text" placeholder="Rescheduling Fee" id="rechedulefee" >
                    </div>
                    </div>  
                 <!-- client 2022 project update -->
