    ...
    <div class="page-wrapper">
        <div class="invoice-card" id="PrintMe">
            ...
            <div class="invoice-head">
                ...
                <h5 class="item-title text-left"><?php echo $setting->text_logo   ; ?></h5>
                ...
                <!-- New code 2021 direct update    -->
                    <h5 class="item-title text-left"><?php echo display('booking_id') ?>: <?php echo $ticket->id_no; ?></h5>
                    <p class="item-title text-left"><?php echo display('route_name') ?>: <?php echo(!empty($ticket->route_name) ? $ticket->route_name : null) ?></p>
                    
                    <p class="item-title text-left"><?php echo display('payment_status'); ?>: 
                        <?php
                ...
                <div class="date-info">
                    <div class="row">
                        <div class="col-sm-6" align="left">
                          Pick Up Point:  <?php echo(!empty($pickup->name) ? $pickup->name : null) ?> 
                        </div>

                        <div class="col-sm-6" align="left">
                          Drop off Point: <?php echo(!empty($drop->name) ? $drop->name : null) ?>
                        </div>
                        ...
                        <?php if( $ticket->other_location_id != null ) : ?>  
                            ...
                            ?>
                        <div class="col-sm-6" align="left">
                          Other Location: <?php echo $OtherLocation->location_name; ?>
                        </div>
            ...
            <div class="invoice-details">
                <div class="invoice-list">
                    ...
                    <div class="invoice-data">
                        ...
                        <div class="row-data">
                            <div class="item-info">
                                ...
                                <p class="item-title"><span class="bolder"><?php echo display('email') ?> :</span><span><?php echo(!empty($passanger->email) ? $passanger->email : null) ?></span></p>
                                <p class="item-title"><span class="bolder">Nid/Passport :</span><span><?php echo(!empty($passanger->nid) ? $passanger->nid : null) ?></span></p>
                    ...
                    <?php if( $ticket->other_location_id != null ) : ?>  
                        <div class="row-data">
                            <div class="pack-info">
                                <div class="item-title">
                                    <p class="bolder">Other Location</p>
              ...
              <?php foreach ($partial_pay_all as $item) : ?>
                ...
                <div class="row-data">
                    <div class="item-info">
                        <h5 class="item-title"><?php echo $item->payment_step ; ?></h5>
                    </div>
                    <h5 class="my-5">
                        <?php 
                ...
                <div class="row-data">
                    <div class="item-info">
                        <h5 class="item-title">Total :</h5>
                    </div>
                    <h5 class="my-5">
                        <?php 
                            echo ($appSetting->currency_placement == 'Left')?$appSetting->currency:''; 
                        ?>
                            <?php echo $counts =  array_sum(array_column($partial_pay_all, 'amount'));  ?>
                        <?php 
                            echo ($appSetting->currency_placement == 'Right')?$appSetting->currency:''; 
                        ?>
                    </h5>
