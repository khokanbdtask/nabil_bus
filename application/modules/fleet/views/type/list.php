                    ...
                    <table class="datatable table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo display('total_weight')." (KG)" ?></th>
                                <th><?php echo display('layout') ?></th>
                                <th><?php echo display('luggage_service') ?></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $fleet_type->type; ?></td>
                                 ...
                                 <td><?php echo $fleet_type->total_weight; ?></td>
                                  <td><?php echo $fleet_type->layout; ?></td>
                                <td><?php echo (($fleet_type->luggage_service==1)?display('active'):display('inactive')); ?></td>
