    ...
    public function form($id = null)
    {
        ...
        if ($ids) {
            if ($this->input->post('email') == $this->input->post('old_email')) {
                ...
                $this->form_validation->set_rules('email', display('email'), 'valid_email|max_length[100]|is_unique[tkt_passenger.email]');
            }
        } else {
            $this->form_validation->set_rules('email', display('email'), 'valid_email|max_length[100]|is_unique[tkt_passenger.email]');
        }
        ...
        $this->form_validation->set_rules('nid', display('nid'), 'max_length[50]');
        /*-----------------------------------*/
        if ($image = $this->fileupload->do_upload('./application/modules/luggage/assets/images/passenger/', 'image')) {
...
//			    die();
                ...
                if ($this->passenger_model->create($postData)) {
                    ...
                    redirect('luggage_nitol/passenger/view/' . $id);
                } else {
                    $this->session->set_flashdata('exception', display('please_try_again'));
                }
                redirect("luggage_nitol/passenger/form");
                ...
                redirect("luggage_nitol/passenger/form/" . $postData['id']);
    ...
    */
    ...
    public function delete($id = null)
    {
        ...
        redirect('luggage_nitol/passenger/index');
    }
    /*
    |----------------------------------------------
