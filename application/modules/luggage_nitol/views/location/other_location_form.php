        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <a href="<?php echo base_url('luggage_nitol/packages/luggageOtherLocation') ?>" class="btn btn-sm btn-success" title="List">
                            <i class="fa fa-list"></i> <?php echo display('list') ?></a>
                        <?php if (isset($trips->trip_id)): ?>
                            <a href="<?php echo base_url('luggage_nitol/packages/otherLocationFromLoad') ?>" class="btn btn-sm btn-info"
            ...
            <div class="panel-body">
                ...
                <?= form_open('luggage_nitol/packages/addOtherLocation') ?>
