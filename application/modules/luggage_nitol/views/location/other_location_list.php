        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <a href="<?php echo base_url('luggage_nitol/packages/otherLocationFromLoad') ?>" class="btn btn-sm btn-info" title="Add"><i
                        ...
                        <?php foreach ($otherlocation as $otherlocationValue) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($this->permission->method('luggage_nitol', 'update')->access()): ?>
                                        <a href="<?php echo base_url("luggage_nitol/packages/otherLocationEdit/$otherlocationValue->otherlocationid") ?>"
