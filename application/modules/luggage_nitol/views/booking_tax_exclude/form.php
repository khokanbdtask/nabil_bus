...
/*
   ...
   //      .appendTo("body");                    // add iframe to the DOM to cause it to load the page
                        ...
                        // w = window.open("<?php echo base_url('luggage_nitol/luggage/view/'); ?>"+data.ticket.id_no+"","_blank");
                        // w.document.open();
                        // w.document.write(w);
                        // w.document.close();
                        // w.focus();
                ...
                //     //     window.open("<?php echo base_url('luggage_nitol/luggage/invoice/'); ?>"+data.ticket.id_no+"", "_blank");
                //     // }
