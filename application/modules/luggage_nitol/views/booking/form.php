...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div id="luggage_form">
                <?php echo form_open('luggage_nitol/luggage/createBooking', 'id="bookingFrm"') ?>
                ...
                <div class="form-group row">
                    <label for="approximate_time" class="col-sm-3 col-form-label"><?php echo display('booking_date') ?>
                        *</label>
                    <div class="col-sm-9">
                        <input name="approximate_time" required="" class="findTripByRouteDate form-control datepicker" type="text"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <?php echo form_dropdown('ftypes', $tps, '', 'id="ftypes" class="findTripByRouteDate form-control" required=""') ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <?php echo form_dropdown('route_id', $route_dropdown, '', 'id="route_id" class="findTripByRouteDate form-control" required=""') ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select required="" class="packages form-control" name="packages" id="packages"></select>
                    </div>
                </div>
                <!-- New code 2021 direct update  -->
                <div class="form-group row">
                    <label for="details_luggage"
                           class="col-sm-3 col-form-label">Luggage Detail </label>
                    <div class="col-sm-9">
                        <input  type="text" class="packages form-control" name="details_luggage" id="details_luggage" placeholder="Luggage Detail"></input>
                    </div>
                </div>
                <!-- New code 2021 direct update  -->  
            ...
            ?>
                ...
                <div class="form-group row">
                    <label for="price" class="col-sm-3 col-form-label">Other Fees</label>
                    <div class="col-sm-9">
                        <div class="row">
                            <strong class="col-sm-3">Extra Fee</strong>
                            <strong class="col-sm-3">Market Value</strong>
                            <strong class="col-sm-3">Insurable Fee</strong>
                            <strong class="col-sm-3">Wrapping Fee</strong>
                        </div>
                        <div class="row">
                            <div class="col-sm-3">
                                <input name="extra_fee" class="form-control text-right" type="number"
                                       placeholder="" id="extra_fee" 
                                       value="0">
                            ...
                            <div class="col-sm-3">
                                <input name="market_value" class="form-control text-right" type="number"
                                       placeholder="" id="market_value" required>
                            </div>

                            <div class="col-sm-3">
                                <input name="insurance_fee" class="form-control text-right" type="number"
                                       placeholder="" id="insurance_fee" value="0">
                            </div>

                            <div class="col-sm-3">
                                <input name="wrapping_fee" class="form-control text-right" type="number"
                                       placeholder="" id="wrapping_fee" required>
                            </div>
                    ...
                    <div class="col-sm-9">
                        <div class="row">
                            ...
                            <div class="col-sm-3 text-center">
                                <input type="checkbox" name="same_as_sender" id="same_as_sender" disabled> Same as sender
                            </div>
                        </div>
                    </div>
                </div>
 ...
 <!-- New code 2021 direct update  -->
                <div class="form-group row" id="partialdiv">
                    <label for="offerCode" class="col-sm-3 col-form-label">Partial amount</label>
                    <div class="col-sm-9">
                        <input name="partialamount" class="form-control" type="text"
                               placeholder="Partial amount" id="partialamount"
                               >
                        <div id="offerHelpText"></div>
                    </div>
                </div>
                ...
                <div class="form-group row" id="paytype">
                    ...
                    <div class="col-sm-9">
                                <div class="form-check form-check-inline">
                                        ...
                                        <input class="form-check-input" type="radio" name="paytype" id="check" value="bank">
                                        <label class="form-check-label" for="paytype">Bank</label>

                                        <input class="form-check-input" type="radio" name="paytype" id="check" value="eft">
                ...
                <div class="form-group row">
                    <label for="offerCode" class="col-sm-3 col-form-label">Payment Detail:</label>
                    <div class="col-sm-9">
                        <input name="parital_detail" class="form-control" type="text"
                               placeholder="" id="parital_detail"
                               >
                        <div id="offerHelpText"></div>
                    </div>
                </div>
...
<!-- add a modal file by a awesome programmer -->
<?php  
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == true) {
                        ...
                        makeSameSenderReceiver(sender_email, data.sender_id_no, senderHelpText);
...
/*
        ...
        */
        ...
        //         $.ajax({
        //             url: '<?php echo base_url('luggage_nitol/luggage/fleetfacilities') ?>',
        //             method: 'post',
        //             dataType: 'json',
        //             data:
        //                 {
                    ...
                    .then((value) => {
                      switch (value) {
                        ...
                        .then((value) => {
                            ...
                            .attr("src", "<?php echo base_url('luggage_nitol/luggage/invoice/'); ?>"+data.id_no) // point the iframe to the page you want to print
                        ...
                        case "catch":
                          window.open("<?php echo base_url('luggage_nitol/luggage/view/'); ?>"+data.id_no, '_self','',false);
                          break;
                     
                        default:
                          window.open("<?php echo base_url('luggage_nitol/luggage/index/'); ?>");
                      }
                    });
        ...
        */
        ...
        $(".findTripByRouteDate").change(function () {
            ...
            if (tps.length == 0) {
                ...
                if (route_id.length == 0) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url('luggage_nitol/luggage/findTripByRouteDate') ?>',
                        method: 'post',
                        dataType: 'json',
                        data: {
                            '<?php echo $this->security->get_csrf_token_name() ?>': '<?php echo $this->security->get_csrf_hash() ?>',
        ...
        $("#price").on('keyup change', function () {
            ...
            //new code for extra fee
                var newTotal = total_price;

                var extraFee =  parseFloat($("#extra_fee").val());
                var insurancefee =  parseFloat($("#insurance_fee").val());
                var wrappingfee =  parseFloat($("#wrapping_fee").val());

                if(isNaN(extraFee)) {
                    var extraFee = 0;
                }
                if(isNaN(wrappingfee)) {
                    var wrappingfee = 0;
                }
                ...
                var grandTotal = newTotal + extraFee + insurancefee + wrappingfee;
        ...
        $("#extra_fee").on('keyup change', function () {
            
            
            //new code for extra fee
                var newTotal = parseFloat( $("#grandtotal").val());

                var extraFee =  parseFloat($("#extra_fee").val());
                var insurancefee =  parseFloat($("#insurance_fee").val());
                var wrappingfee =  parseFloat($("#wrapping_fee").val());
                var discont =  parseFloat($("#discount").val());
                ...
                var grandTotal = parseFloat((newTotal + extraFee + insurancefee + wrappingfee)-discont) ;
        ...
        $("#insurance_fee").on('keyup change', function () {
        ...
        $("#wrapping_fee").on('keyup change', function () {
...
//// Package Price & Package Urgent Price
        ...
        $('#packages').change(function () {
            ...
            // alert(package_id);
                ...
                $.ajax({
                    url: '<?php echo base_url('luggage_nitol/luggage/priceByRouteTypeAndFleetType') ?>',
                    method: 'post',
                    dataType: 'json',
                    data:
                        {
                    ...
                    success: function (data) {
                        ...
                        else
                        {
                            ...
                            //new code for extra fee
                                var newTotal = total_price+total_price_without_tax;
                                ...
                                var grandTotal = parseFloat(newTotal + extraFee + insurancefee + wrappingfee);
                                $("#amount").val(grandTotal);
        ...
        */
        $("#offerCode").on('change', function () {
            ...
            if ($(this).val().length != null) {
                ...
                $.ajax({
                    url: '<?php echo base_url('luggage_nitol/luggage/findOfferByCode') ?>',
                    method: 'post',
                    dataType: 'json',
                    data: {
                        '<?php echo $this->security->get_csrf_token_name() ?>': '<?php echo $this->security->get_csrf_hash() ?>',
        ...
        */
        $("#sender_email").bind('change paste', function () {
            ...
            $.ajax({
                url: '<?php echo base_url('luggage_nitol/luggage/findPassengerName') ?>',
                method: 'post',
                dataType: 'json',
                data: {
                    '<?php echo $this->security->get_csrf_token_name() ?>': '<?php echo $this->security->get_csrf_hash() ?>',
                ...
                success: function (data) {
                    ...
                    makeSameSenderReceiver(senderEmail, data.passenger_id, data.name);  
                },
                error: function (e) {
                    alert('failed!');
                }
...
$.ajax({
    url : '<?php echo base_url('luggage_nitol/Packages/findExtraLocation/') ?>'+routeId,
    method: 'get',  
    dataType: 'json',          
    ...
    success: function(data) {
        ...
        $.each(data, function(key, value) {
            ...
            newOption += "<option value ="+value.id+" >"+value.location_name+"<option/>";
...
function makeSameSenderReceiver(senderEmail, senderId, senderName) {
    if (senderId) {
        $("#same_as_sender").prop('disabled', false);

        // Attach the change event to #same_as_sender if it has not been attached yet
        if (!$('#same_as_sender').data('change-event-attached')) {
            $('#same_as_sender').change(function(){
                if ($(this).is(':checked')) {
                    $("#receiver").val(senderEmail);
                    $("#receiver_id_no").val(senderId);
                    $("#receiverHelpText").empty().html(senderName);
                } else {
                    $("#receiver").val('');
                    $("#receiver_id_no").val('');
                    $("#receiverHelpText").empty();
                }
            }).data('change-event-attached', true);
        }

    } else {
        // Check if the checkbox is checked and uncheck it if necessary
        if ($("#same_as_sender").is(':checked')) {
            $("#same_as_sender").prop('checked', false);
        }
        $("#same_as_sender").prop('disabled', true);
