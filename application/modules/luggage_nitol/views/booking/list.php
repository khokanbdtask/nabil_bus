    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                ...
                <?= form_open('luggage_nitol/luggage/index','class="form-inline"') ?> 
     ...
     <!-- New code 2021 direct update  -->
            <!-- <div class="col-sm-12" style="margin-bottom:20px">
                        <?php echo form_open('luggage_nitol/luggage/index', 'class="form-horizontal" method="post"')?>
                            ...
                            <div class="form-group">
                                    <label for="luggagebookingid" class="col-sm-2 control-label">Booking Id</label>
                                    <div class="col-sm-8">
                                         <input name="luggagebookingid" id="luggagebookingid" type="text" placeholder="BOOKING-ID" class="form-control " value="">
                                    </div>
                    ...
                    <table class="luggagelist table table-bordered ">
                        ...
                        foreach ($bookings as $booking) {
                            ...
                            <?php if ($booking->payment_status == 1): ?>
                                <a type="button" class="btn btn-default btn-xs mt-2" data-toggle="modal" data-target="#<?php echo  $booking->id_no ?>" data-whatever="@mdo"><i class="fa fa-tag" aria-hidden="true"></i></a>


                                <div class="modal fade" id="<?php echo  $booking->id_no ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                
                                    
                                        <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">How Many Copy You Want to Print ?</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>

                                                <?php echo form_open('luggage_nitol/luggage/multitag') ?>
                                                <div class="modal-body">
                                               
                                                    <div class="form-group">
                                                        <label for="numberofprint" class="col-form-label">Number Of Print</label>
                                                        <input type="number" class="form-control" id="numberofprint" name="numberofprint">
                                                    </div>
                                                    <input type="hidden" class="form-control"  name="bookingid" value="<?php echo  $booking->id_no ?>">
                            
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                    <!-- <button type="submit" class="btn btn-primary">Submit</button> -->
                                                    <button type="submit" class="btn btn-success w-md m-b-5">print</button>
                                                </div>
                                                </div>
                                                <?php echo form_close() ?>
                                            </div>
                            ...
                            <?php if ($booking->payment_status != 1): ?>
                                    ...
                                    <a  target="_blank" href="<?php echo base_url("luggage_nitol/luggage/invoice/$booking->id_no") ?>"
                                           class="btn btn-primary btn-xs " data-toggle="tooltip" data-placement="left"
                                           title="pos invoice"><i class="fa fa-print" aria-hidden="true"></i></a>

                                    <!-- <a  target="_blank" href="<?php echo base_url("luggage_nitol/luggage/tag/$booking->id_no") ?>"
                                           class="btn btn-success btn-xs mt-2" data-toggle="tooltip" data-placement="left"
                                           title="Tag It"><i class="fa fa-tag" aria-hidden="true"></i></a> -->
