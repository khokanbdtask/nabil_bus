    ...
    <div class="page-wrapper">
        <div class="invoice-card" id="PrintMe">
            ...
            <div class="invoice-details">
                            ...
                            <div class="item-info">
                                ...
                                <?php if( $ticket->other_location_id != null ) : ?> 
                                    <?php
                                                ...
                                                ?>
                                    <p class="item-title"><span class="bolder">Final Destination :</span><span><?php echo $OtherLocation->location_name ?></span></p>
                                <?php endif ?> 
             ...
             <div class="row-data">
                    <div class="item-info">
                        <h5 class="item-title">Market Value</h5>
                    </div>
                    <h5 class="my-5">
                    <?php echo ($appSetting->currency_placement == 'Left')?$appSetting->currency:''; ?>
                    <?php echo $discount = (!empty($ticket->market_value) ? $ticket->market_value : 0) ?>
                    <?php echo ($appSetting->currency_placement == 'Right')?$appSetting->currency:''; ?>
                    </h5>
            </div>
            ...
            <!--</div>-->
                ...
                <div class="row-data">
                    <div class="item-info">
                        <h5 class="item-title">Extra Fee</h5>
                    </div>
                    <h5 class="my-5">
                    <?php echo ($appSetting->currency_placement == 'Left')?$appSetting->currency:''; ?>
                    <?php echo $discount = (!empty($ticket->extra_fee) ? $ticket->extra_fee : 0) ?>
                    <?php echo ($appSetting->currency_placement == 'Right')?$appSetting->currency:''; ?>
                    </h5>
                </div>
                <?php endif ?> 
                ...
                <div class="row-data">
                    <div class="item-info">
                        <h5 class="item-title">Insurance Fee</h5>
                    </div>
                    <h5 class="my-5">
                    <?php echo ($appSetting->currency_placement == 'Left')?$appSetting->currency:''; ?>
                    <?php echo $discount = (!empty($ticket->insurance_fee) ? $ticket->insurance_fee : 0) ?>
                    <?php echo ($appSetting->currency_placement == 'Right')?$appSetting->currency:''; ?>
                    </h5>
                </div>
                ...
                <div class="row-data">
                    <div class="item-info">
                        <h5 class="item-title">Wrapping Fee</h5>
                    </div>
                    <h5 class="my-5">
                    <?php echo ($appSetting->currency_placement == 'Left')?$appSetting->currency:''; ?>
                    <?php echo $discount = (!empty($ticket->wrapping_fee) ? $ticket->wrapping_fee : 0) ?>
                    <?php echo ($appSetting->currency_placement == 'Right')?$appSetting->currency:''; ?>
                    </h5>
                </div>
