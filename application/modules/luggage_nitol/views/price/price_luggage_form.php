<div class="form-group text-right">
        <a href="<?php echo base_url('luggage_nitol/packages/'); ?>"><button type="button" class="btn btn-primary btn-md">
    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default thumbnail">
            ...
            <div class="panel-body">
                <?= form_open('luggage_nitol/packages/create_price',array('name'=>'myForm')) ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <?php echo form_dropdown('route_id[]',$rout,$rout,'class="form-control" style="width:100%"') ?>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#vehicle_type_id').change(function () {
            ...
            $.ajax({
                url:"<?php echo base_url('luggage_nitol/packages/max_luggage_weight'); ?>",
                method:"POST",
