        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <div class="col-sm-12" >
                    ...
                    <table class="datatable table table-bordered " id="PrintMe">
                        ...
                        <tbody>
                            ...
                            <tr class="<?php echo (!empty($booking->tkt_refund_id) ? "bg-danger" : null ) ?> <?php echo (($booking->payment_status != "NULL") ? "bg-danger" : null ) ?>">
                                <td><?php echo $sl++; ?></td>
                                ...
                                <td class="text-right">
                                    ...
                                    <?php echo $booking->extra_fee; ?>
                                
                                </td>
                                <td class="text-right">
                                <?php if ($booking->payment_status != "NULL") : ?>
                                    <?php echo $booking->partialpay; ?>
                                <?php else : ?>
                                ...
                                <?php if ($booking->payment_status != "NULL") : ?>
                                    <?php 
                                        echo $dueAmount = (int)$booking->amount - (int)$booking->partialpay;
                                    ?>
                                <?php else : ?>
                                    <?php echo 0; ?>
                                <?php endif; ?>
                                ...
                                <td class="text-right">
                                    ...
                                    <?php echo $booking->discount; ?>
                                
                                </td>
                                <td class="text-right">
                                
                                    <?php echo ($booking->amount-$booking->discount); ?>
