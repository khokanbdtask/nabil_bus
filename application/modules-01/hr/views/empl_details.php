        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        ...
                        <a href="<?php echo base_url("hr/hr_controller/download?file=$details->document_pic") ?>"
                           target="_blank" download class="btn btn-sm btn-primary"><i
                                    class="fa fa-download"></i> <?php echo display('download_document') ?></a>

                        <a href="#" class="btn btn-sm btn-danger" onclick="printContent('PrintMe')" title="Print"> <i
            ...
            <div class="panel-body" id="PrintMe">
                <table class="table table-hover" width="100%">
                    <thead>
                    <tr>
                        <th colspan="2"><img src="<?php echo base_url($details->picture) ?>" width="200" height="200">
                        </th>
                    </tr>
                    <tr>
