        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <a href="<?php echo base_url('passenger/index') ?>" class="btn btn-sm btn-success"
                           title="List"> <i class="fa fa-list"></i> <?php echo display('list') ?></a>
                        <?php if ($passenger->id): ?>
                            <a href="<?php echo base_url('passenger/form') ?>" class="btn btn-sm btn-info"
            ...
            <div class="panel-body">
                ...
                <?= form_open_multipart('passenger/form') ?>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <input name="firstname" class="form-control" type="text"
                                       ...
                                       value="<?php echo $passenger->firstname ?>" required>
                            </div>
                            <div class="col-sm-4">
                                <input name="middle_name" class="form-control" type="text"
                                       placeholder="<?php echo display('middle_name') ?> (optional)"
                                       value="<?php echo $passenger->middle_name ?>">
                            </div>
                            <div class="col-sm-4">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input name="email" class="form-control" type="email"
                               ...
                               value="<?php echo $passenger->email ?>" required>
                        <input name="old_email" class="form-control" type="hidden"
                               placeholder="<?php echo display('email') ?>" id="email"
                               value="<?php echo $passenger->email ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input name="old_password" class="form-control" type="hidden"
                               placeholder="<?php echo display('password') ?>" id="old_password"
                               value="<?php echo $passenger->password ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="email" class="col-sm-3 col-form-label"><?php echo display('nid') ?> *</label>
                    <div class="col-sm-9">
                        <input name="nid" class="form-control" type="text" placeholder="<?php echo display('nid') ?>"
                               id="nid" value="<?php echo $passenger->nid ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="row">
                            <div class="col-sm-2">
                                <img src="<?php echo base_url(!empty($passenger->image) ? $passenger->image : "./assets/img/icons/default.jpg") ?>"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <label class="radio-inline">
                            <?php echo form_radio('status', '1', (($passenger->status == 1) ? 1 : 0), 'id="status"'); ?>
                            Active
                        </label>
                        <label class="radio-inline">
                            <?php echo form_radio('status', '0', (($passenger->status == "0") ? 1 : 0), 'id="status"'); ?>
                            Inactive
                        </label>
                    </div>
                </div>
