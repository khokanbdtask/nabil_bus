            ...
            <div id="home" class="tab-pane active">
               <div class="passenger-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="phone" value="<?php echo $this->session->userdata('phone'); ?>" required class="form-control" id="phone"  placeholder="Phone number"  >
                    </div>
                    <div class="form-group">
                        <label><?php echo display('email'); ?> *</label>
                        <input type="email" name="email" class="form-control" id="email" required placeholder="Email address"  value="<?php echo $this->session->userdata('p_email'); ?>">
                    </div>
                    <div class="form-group">
