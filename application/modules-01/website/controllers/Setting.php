...
class Setting extends MX_Controller
{
    ...
    public function form()
    {
        ...
        $this->form_validation->set_rules('currency_placement', display('currency_placement'), 'required|max_length[6]');
        ...
        $data['website'] = (object)$postData = [
            ...
            'currency_placement' => $this->input->post('currency_placement'),
    ...
    */
    public function offer()
    {
        ...
        if ($this->form_validation->run() && (!empty($postData['image']))) {
            ...
            $data['module'] = "website";
            $data['page'] = $this->active_theme . "/setting/offer";
            echo Modules::run('template/layout', $data);
        }
    }
