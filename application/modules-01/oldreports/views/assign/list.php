                        ...
                        <tbody>
                            ...
                            <tr class="<?php echo (!empty($assign->isClosed)?$assign->isClosed:null) ?>">
                                ...
                                <td>
                                    ...
                                    <a target="_blank" href="<?php echo base_url("trip/assign/view/$assign->id_no") ?>"><?php echo $assign->trip_title; ?></a>
                                    <?php else: ?>
                                ...
                                <td><?php echo date("d-m-Y h:i:s A",strtotime($assign->createdate)); ?></td>
                                <td>
                                    <?php 
                                    if($assign->isClosed){
                                    echo date("d-m-Y h:i:s A",strtotime($assign->date));
                                }else{ 
                                    echo date("d-m-Y h:i:s A",strtotime($assign->assign_time));
                                    } 
                                    ?>
