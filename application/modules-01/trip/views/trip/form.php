        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <a href="<?php echo base_url('trip/trip/index') ?>" class="btn btn-sm btn-success" title="List">
                            <i class="fa fa-list"></i> <?php echo display('list') ?></a>
                        <?php if (isset($trips->trip_id)): ?>
                            <a href="<?php echo base_url('trip/trip/form') ?>" class="btn btn-sm btn-info"
            ...
            <div class="panel-body">
                ...
                if(isset($trips->trip_id)) 
                    {
                        echo form_hidden('trip_id', $trips->trip_id);
                    }
                ?>

                <div class="form-group row">
                    <label for="trip_title" class="col-sm-3 col-form-label"><?php echo display('trip_title') ?>
                        *</label>
                    <div class="col-sm-9">
                        <textarea name="trip_title" id="trip_title" class="form-control"
                                  readonly=""><?php echo (isset($trips->trip_title)) ? $trips->trip_title : ''; ?></textarea>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <label class="radio-inline">
                            <?php echo
                            (isset($trips->trip_id)) ? form_radio('status', '1', (($trips->status == 1) ? 1 : 0), 'id="status"') : form_radio('status', '1', '0', 'id="status"') ?>
                            Active
                        </label>
                        <label class="radio-inline">
                            <?php
                            (isset($trips->trip_id)) ? form_radio('status', '1', (($trips->status == 0) ? 1 : 0), 'id="status"') : form_radio('status', '1', '0', 'id="status"') ?>
                            Inactive
                        </label>
                    </div>
                </div>
