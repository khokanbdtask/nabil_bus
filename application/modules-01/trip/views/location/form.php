        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <a href="<?php echo base_url('trip/location/index') ?>" class="btn btn-sm btn-success"
                           title="List"> <i class="fa fa-list"></i> <?php echo display('list') ?></a>
                        <?php if ($location->id): ?>
                            <a href="<?php echo base_url('trip/location/form') ?>" class="btn btn-sm btn-info"
            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input name="name" class="form-control" type="text"
                               placeholder="<?php echo display('location_name') ?>" id="name"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea name="description" placeholder="<?php echo display('description') ?>"
                                  class="form-control" id="description"><?php echo $location->description ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea name="google_map" placeholder="<?php echo display('google_map') ?>"
                                  class="form-control" id="google_map"><?php echo $location->google_map ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <img src="<?php echo base_url(!empty($location->image) ? $location->image : "./assets/img/icons/default.jpg") ?>"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <label class="radio-inline">
                            <?php echo form_radio('status', '1', (($location->status == 1) ? 1 : 0), 'id="status"'); ?>
                            Active
                        </label>
                        <label class="radio-inline">
                            <?php echo form_radio('status', '0', (($location->status == "0") ? 1 : 0), 'id="status"'); ?>
                            Inactive
                        </label>
                    </div>
                </div>
