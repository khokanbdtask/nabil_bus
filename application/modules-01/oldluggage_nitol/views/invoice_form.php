    ...
    <div class="card-body">
      <?php echo form_open_multipart("invoice/add_invoice/", array('id' => 'manual_sale_insert')) ?>            
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <div class="">
                          <input type="text" name="customer_name" id="customer_name" class="form-control" value="<?php echo $customer_name?>" onkeyup="CustomerListInvoice()">
                    ...
                    <div class="col-md-4">
                        <div class="">
                            ...
                            <input type="text" name="date" class="form-control datepicker" id="date" placeholder="<?php echo lan('date')?>" value="">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <div class="">
                            ...
                            <input type="text" class="form-control" name="details" id="details" placeholder="<?php echo lan('details')?>" value="">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                                ...
                                <tbody id="addinvoiceItem">
                                       <tr>
                                        <td class="product_field">
                                            <input type="text" name="product_name" onkeyup="invoice_productList(1);" onkeypress="invoice_productList(1);" class="form-control productSelection" placeholder='<?php echo lan('medicine_name') ?>' required="" id="product_name_1" tabindex="7">
                                        ...
                                        <td>
                                            <select class="form-control select2" id="batch_id_1" name="batch_id[]"  onchange="product_stock_invoice(1)" tabindex="8" >
                                                <option></option>
                                            </select>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" name="product_quantity[]" onkeyup="quantity_calculate_invoice(1),checkqty_invoice(1);" onchange="quantity_calculate_invoice(1);" class="total_qntt_1 form-control text-right allownumericwithdecimal" id="total_qntt_1" placeholder="0.00" min="0" tabindex="9" required/>
                                        </td>

                                         <td>
                                            <input type="text" name="box_quantity[]" onkeyup="quantity_calculate_invoice(1),checkqty_invoice(1);" onchange="quantity_calculate_invoice(1);" class=" form-control text-right" id="box_qty_1" placeholder="0.00" min="0" tabindex="9" readonly="" />
                                            <input type="hidden" id="u_box_1" name="b_qty"/>
                                        </td>
                                        <td class="invoice_fields">
                                            <input type="text" name="product_rate[]" id="price_item_1" class="price_item1 price_item form-control text-right allownumericwithdecimal" tabindex="10" required="" onkeyup="quantity_calculate_invoice(1),checkqty_invoice(1);" onchange="quantity_calculate_invoice(1);" placeholder="0.00" min="0"/>
                                        </td>
                                        <!-- Discount -->
                                        <td>
                                            <input type="text" name="discount[]" onkeyup="quantity_calculate_invoice(1),checkqty_invoice(1);"  onchange="quantity_calculate_invoice(1);" id="discount_1" class="form-control text-right allownumericwithdecimal" min="0" tabindex="11" placeholder="0.00"/>
                                     ...
                                     foreach($taxes as $taxfldt){?>
                                          ...
                                          <button type="button" class="btn btn-danger-soft btn-sm" tabindex="12" onclick="deleteRowinvoice(this)"><i class="far fa-trash-alt"></i></button>
                                        </td>
                                    </tr>
                                </tbody>
                       <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <input type="text" id="invdcount" class="form-control text-right allownumericwithdecimal" name="invoice_discount" onkeyup="calculateSumInvoice(),checknum();" onchange="calculateSumInvoice()" placeholder="0.00" />
                                           
                                        </td>
                                        <td> 
                                              <button  class="btn btn-info" type="button" onClick="addInputFieldInvoice('addinvoiceItem');" tabindex="12" id="add_invoice_item"><i class="fa fa-plus"></i>
                                            </button>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <td class="text-right">
                                            ...
                                            onkeyup="calculateSumInvoice(),checknum();" class="form-control text-right allownumericwithdecimal" name="paid_amount" placeholder="0.00" tabindex="13"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center">
