...
// update terms and condition
    ...
    public function luggage_report($datefrom = "", $dateto = "", $ftypes = "", $route_id = "",$payment_status = "")
    {
        ...
        if (empty($ftypes) && !empty($route_id)) {
            ...
            $this->db->where('luggage_booking.booking_date >=', $datefrom);
            $this->db->where('luggage_booking.booking_date <=', $dateto);
            $query = $this->db->get();
            return $query->result();
