        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <table width="100%" class="tripAsignDataTable table table-striped table-bordered table-hover">
                    ...
                    <tfooter>
                        <tr><td colspan="3" class="text-right"><b>Total </b></td><td class="text-right"><b><?php echo $currency; ?> <?php echo (!empty($total_debit))?$total_debit:0;?></b></td><td class="text-right"><b><?php echo $currency; ?> <?php echo (!empty($total_credit))?$total_credit:0;?></b></td><td class="text-right"><b><?php echo $currency; ?> <?php echo (!empty($total_balance))?$total_balance:0;?></b></td></tr>
                    </tfooter>
