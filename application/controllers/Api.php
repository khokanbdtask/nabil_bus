     ...
     $removelastcomma= trim($bookedSeats->booked_serial,',');
      ...
      $rightseat =["A3","B3","C3","D3","E3","F3","G3","H3","I3","J3","K3","L3","M3","N3"];
       ...
       asort($righttestbookarray);
        ...
        //stopages
         $tripLocation = $this->api_model->stoppage_points_full($trip_route_id);
         
         //print_r($tripLocation); return;

        $locationArray = array();
        $locationArray = array_map(function ($val1, $val2) {
            return array('id' => $val1, 'location_name' => $val2);
        }, explode(',', $tripLocation->stoppage_points), explode(',', $tripLocation->location_name));
