$(document).ready(function () {
    ...
    $('.datatable').DataTable({
        ...
        "lengthMenu": [[15, 25, 50, 100, 150, 200, 500, -1], [15, 25, 50, 100, 150, 200, 500, "All"]],
        buttons: [
...
////// Luggage Module Datatable
    $('.datatable_luggage').DataTable({
        responsive: true,
        paging: false,
        dom: "<'row'<'col-sm-8 text-center'B><'col-sm-4'f>>tp",
        "lengthMenu": [[15, 25, 50, 100, 150, 200, 500, -1], [15, 25, 50, 100, 150, 200, 500, "All"]],
        buttons: [
            {extend: 'copy', className: 'btn-sm', footer: true},
            {extend: 'csv', title: 'Luggage Report', className: 'btn-sm', footer: true},
            {extend: 'excel', title: 'Luggage Report', className: 'btn-sm', footer: true},
            {extend: 'pdf', title: 'Luggage Report', className: 'btn-sm', footer: true},
            {extend: 'print', title: 'Luggage Report', className: 'btn-sm', footer: true}
        ]
    });
