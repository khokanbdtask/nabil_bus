            ...
            <div class="col-sm-12 col-md-8 col-md-offset-2" id="PrintMe">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td><strong><?php echo display('pickup_location') ?>:</strong>
                                    <span><?php echo(!empty($ticket->pickup_trip_location) ? $ticket->pickup_trip_location : null) ?></span>
                                </td>
                                <td><strong><?php echo display('drop_location') ?>:</strong>
                                    <span><?php echo(!empty($ticket->drop_trip_location) ? $ticket->drop_trip_location : null) ?></span>
                                </td>
                                <td><strong><?php echo display('date') ?>:</strong>
                                    <span><?php echo(!empty($ticket->booking_date) ? $ticket->booking_date : null) ?></span>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="col-sm-12">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td colspan="3"></td>
                                        <th class="text-right"><?php echo display('bank_commission'); ?></th>
                                        <th class="text-right"><?php echo $commission = (!empty($commission->bank_commission) ? ($commission->bank_commission * $price) / 100 : 0) ?><?php echo $appSetting->currency; ?></th>
                                    </tr>
                                    <tr>
                                        <td colspan="3"></td>
                                        <th class="text-right"><?php echo display('grand_total') ?></th>
                                        <th class="text-right"><?php echo $price - $discount + $commission ?><?php echo $appSetting->currency; ?></th>
                                    </tr>
                                    </tbody>
                                </table>
                                <table class="table table-responsive">
                                    <tbody>
                                    <tr>
                                        <td style="font-size:10px;"> ** This is Computer Generated Copy. No Signature
                                            Required.
                                        </td>
                                    </tr>
                                    </tbody>
                ...
                <div class="ticket-content" style="margin-top:20px">
                    ...
                    <span><?php echo display('amount') ?> : 
                        <strong><?php echo display('unpaid') ?></strong>
                    </span>
                </div>
            </div>
        </div>
