...
<div class="navbar-custom-menu" style=" float:right;">
    ...
    <ul class="nav navbar-nav">
        ...
        <!-- settings -->
        <li>
            <a href="<?php echo base_url('website/User/upform_pasenger/') . $ticket->tkt_passenger_id_no ?>"
               class="btn btn-sm profile_btn" title="Edit"><?php echo display('profile') ?></a>
        ...
        <li class="dropdown dropdown-user">
            ...
            <a href="#" class="dropdown-toggle setting_icon" data-toggle="dropdown"
               style="color: white;"><span><?php echo $this->session->userdata('firstname') ?></span> <i
        ...
        <div class="panel">
            <div class="panel-heading">
                <div class="panel-title">
                    ...
                    <h4>
                        <a href="<?php echo base_url('website/User/user_details') ?>" class="btn btn-success"
                           title="user list"><i class="fa fa-angle-left"></i><i class="fa fa-angle-left"></i> Back</a>
                        ...
                        <table style="width:100%;margin-bottom:10px">
                            ...
                            <tr>
                                ...
                                <td style="vertical-align:middle;">
                                    <p class="text-right"><strong><?php echo display('phone') ?>
                                            : </strong><?php echo(!empty($appSetting->phone) ? $appSetting->phone : null) ?>
                                    </p>
                                </td>
                            </tr>
                            </tbody>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td><strong><?php echo display('pickup_location') ?>
                                        :</strong> <?php echo(!empty($ticket->pickup_trip_location) ? $ticket->pickup_trip_location : null) ?>
                                </td>
                                <td><strong><?php echo display('drop_location') ?>
                                        :</strong> <?php echo(!empty($ticket->drop_trip_location) ? $ticket->drop_trip_location : null) ?>
                                </td>
                                    ...
                                    <td>
                                        <ul class="list-unstyled">
                                            ...
                                            <li><strong><?php echo display('booking_id') ?> :</strong>
                                                <?php echo(!empty($ticket->booking_id_no) ? $ticket->booking_id_no : null) ?>
                                            </li>
                                    ...
                                    <td>
                                        <dl class="list-unstyled text-right">
                                            <li>
                                                ...
                                                <?php echo(!empty($ticket->tkt_passenger_id_no) ? $ticket->tkt_passenger_id_no : null) ?>
                                            </li>
                                            <li>
