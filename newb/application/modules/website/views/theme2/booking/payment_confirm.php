    ...
    <div id="home" class="tab-pane  active">
        ...
        <table class="table ">
            ...
            <tr>
                ...
                <td><?php echo (!empty($booking->pickup_trip_location)?$booking->pickup_trip_location:null) ?></td>
            </tr>
            <tr>
                <th><?php echo display('drop_location'); ?></th>
                <td><?php echo (!empty($booking->drop_trip_location)?$booking->drop_trip_location:null) ?></td>
            </tr>
            <tr>
           ...
           $('#payu_id').prop('disabled', true);
            ...
            <div style="margin-top:20px">
                ...
                <button type="button" id="paypal_id" class="btn btn-block btn-primary" data-bs-toggle="modal" data-bs-target="#paypal_modal"  disabled=""><?php echo display('paypal') ?> </button>
                  <button type="button" id="cash_id" data-bs-toggle="modal" data-bs-target="#cash_modal" class="btn btn-block btn-primary"  disabled=""><?php echo display('cash') ?> </button>
             <button type="button" id="bank_id" class="btn btn-block btn-primary" data-bs-toggle="modal" data-bs-target="#bank_modal" disabled=""><?php echo display('bank_transaction') ?> </button>
            </div>
...
<!--                    <input type="hidden" name="password"  id="passwords_cash_id" value="--><?php //echo $firstname; ?><!--" required="required">-->
