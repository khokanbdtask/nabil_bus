        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input name="approximate_time" class="findTripByRouteDate form-control datepicker" type="text" placeholder="<?php echo display('booking_date') ?>" id="approximate_time" value="<?php echo  (!empty($booking->approximate_time)?$booking->approximate_time:date('d-m-Y')) ?>">
                    </div>
                    </div>  
                     <div class="form-group row">
                        <label for="ftypes" class="col-sm-3 col-form-label"><?php echo display('types') ?> *</label>
                        <div class="col-sm-9">
                            <?php echo form_dropdown('ftypes', $tps, (!empty($booking->route_id)?$booking->route_id:null), 'id="ftypes" class="findTripByRouteDate form-control"') ?> 
                ...
                ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <input name="price" class="form-control text-right" type="text" placeholder="<?php echo display('price') ?>" id="price" value="<?php echo (isset($booking->price))?$booking->price:'' ?>" >
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    <input name="amount" class="form-control text-right" type="text" readonly placeholder="<?php echo display('amount') ?>" id="amount" value="<?php echo (isset($booking->amount))?$booking->amount:'' ?>" >
                                </div> 
                            </div> 
                        </div>
                    </div> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="row">
                                <div class="col-sm-9">
                                    <input name="passenger_email" class="form-control" type="text" placeholder="<?php echo display('passenger_email') ?>" id="passenger_email" value="<?php echo (isset($booking->email))?$booking->email:'' ?>">
            ...
            success: function(data) 
            {
                if (data.status == true) {
                    ...
                    ////////////Sweet Alert
                        ...
                        // confirm("Do you want to print a bill?")
                        // {
