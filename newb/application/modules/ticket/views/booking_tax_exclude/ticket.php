                                ...
                                <tr>
                                    <td>
                                        <div class="ticket-logo">
                                            <img src="<?php echo base_url(!empty($appSetting->logo)?$appSetting->logo:null) ?>" class="img-responsive" alt="BUS365">
                                        </div>
                                    </td>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-right"><?php echo $price = (!empty($ticket->price)?number_format($ticket->price-$total_commission,3):0) ?> <?php echo $appSetting->currency; ?></th>
                                        </tr>
                                    ...
                                    <tfoot>
                                         <tr>
                                            ...
                                            <th class="text-right"><?php echo $discount = (!empty($ticket->discount)?number_format($ticket->discount,3):0) ?> <?php echo $appSetting->currency; ?></th>
                                        </tr> 
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-right"><?php echo number_format((($ticket_price*$ticket->total_tax)/100),3); ?><?php echo $appSetting->currency; ?></th>
                                        </tr>
                                        <tr>
                                            
                                            <th colspan="4"  class="text-right"><?php echo display('grand_total'); ?></th>
                                            <th class="text-right"><?php echo number_format($ticket->amount,3) ?> <?php echo $appSetting->currency; ?></th>
                                        </tr>
