        ...
        <div class="invoice-card" id="PrintMe">
            ...
            <div class="invoice-head">
                <div class="item-info">
                    ...
                    <img src="<?php echo base_url(!empty($appSetting->logo)?$appSetting->logo:null) ?>" class="mb-15" alt="BUS365">
            ...
            <div class="invoice-details">
                <div class="invoice-list">
                    ...
                    <div class="invoice-data">
                        ...
                        <div class="row-data">
                            <div class="item-info">
                                <p class="item-title"><span class="bolder"><?php echo display('passanger_name') ?>:</span><span><?php echo(!empty($passanger->passenger_name) ? $passanger->passenger_name : null) ?></span></p>
            ...
            <div class="invoice-details" style="border-bottom: 1px dashed #ddd;">
                ...
                <div class="row-data">
                    ...
                    <h5 class="my-5"><?php echo $ticket_price; ?><?php echo $appSetting->currency; ?></h5>
                </div>
                <div class="row-data">
                    <div class="item-info">
                        <h5 class="item-title"><?php echo display('total_tax')."(".$ticket->total_tax."%)"; ?></h5>
                    </div>
                    <h5 class="my-5"><?php echo (($ticket_price*$ticket->total_tax)/100); ?><?php echo $appSetting->currency; ?></h5>
                </div>
                <div class="row-data">
                    <div class="item-info">
            ...
            <div class="invoice-footer" >
                <div class="row-data">
                    <div class="item-info">
                        <small>Thank you for booking ticket with Bus365. If you want refund or cancel booking, please contact as early as possible.
                            <br>
