        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input name="approximate_time" required="" class="findTripByRouteDate form-control datepicker" type="text" placeholder="<?php echo display('booking_date') ?>" id="approximate_time" value="<?php echo  (!empty($booking->approximate_time)?$booking->approximate_time:date('d-m-Y')) ?>">
                    </div>
                    </div>  
                     <div class="form-group row">
                ...
                ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <input name="amount" required="" class="form-control text-right" type="text" readonly placeholder="<?php echo display('amount') ?>" id="amount" value="<?php echo (isset($booking->amount))?$booking->amount:'' ?>" >
                                </div> 
                            </div> 
                        </div>
                    </div> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="row">
                                <div class="col-sm-9">
                                    <input name="passenger_email" required="" class="form-control" type="text" placeholder="<?php echo display('passenger_email') ?>" id="passenger_email" value="<?php echo (isset($booking->email))?$booking->email:'' ?>">
