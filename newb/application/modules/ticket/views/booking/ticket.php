...
<?php } ?>
            ...
            <div class="panel-body" id="PrintMe">
                ...
                <tr>
                    ...
                    <th class="text-right"><?php echo ($ticket_price-$tax_amount); ?><?php echo $appSetting->currency; ?></th>
                </tr>

                                        <tr>
                                            <td colspan="3"></td>
                                            <th class="text-right"><?php echo display('total_tax')."(".$ticket->total_tax."%)"; ?></th>
                                            <th class="text-right"><?php echo $tax_amount; ?><?php echo $appSetting->currency; ?></th>
                                        </tr>
