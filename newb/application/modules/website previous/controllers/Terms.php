        ...
        if ($this->form_validation->run()) {
            ...
            if (empty($postData['id'])) {
                ...
                if ($this->terms_model->create_terms($postData)) {
                    ...
                    redirect('luggage/terms/terms_and_condition_list');
                } else {
                    $this->session->set_flashdata('exception', display('please_try_again'));
                }
                redirect("luggage/terms/terms_and_condition_form");
                ...
                redirect("luggage/terms/terms_and_condition_form/" . $postData['id']);
            }
