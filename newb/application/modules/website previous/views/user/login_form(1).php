            ...
            <div class="panel-body">
                ...
                <div>
                    <span class="text-left"><a type="button" href="" class="" data-target="#login_modal"
                                               data-toggle="modal"><i
                                    class="pe-7s-paper-plane"></i><?php echo display('registrantion') ?></a></span><span
                            class="text-right" style="margin-left: 60px"><a href="" data-toggle="modal"
                                                                            data-target="#for_gott_password"
                                                                            style="color:#0B2161"><?php echo display('forgot_password') ?> ??</a></span>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="<?php echo display('email') ?>" name="rec_email" id="req_email"
                               class="form-control">
                    </div>
                </div>
                <br>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input name="firstname" class="form-control" type="text"
                               placeholder="<?php echo display('firstname') ?>" id="firstname" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input name="lastname" class="form-control" type="text"
                               placeholder="<?php echo display('lastname') ?>" id="lastname" required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input name="email" class="form-control" type="email"
                               placeholder="<?php echo display('email') ?>" id="emails" required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <textarea name="address" class="form-control" placeholder="<?php echo display('address') ?>"
                                  id="address"></textarea>
                    </div>
                </div>
