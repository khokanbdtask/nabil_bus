...
<!--                        <div class="tools-ber">-->
                        ...
                        <form action="<?php echo base_url('website/search') ?>"  style="padding:5px">

                            <div class="row form-block">
                                <div class="col-xs-12 col-sm-3 mt-1 col-md-2">
                                ...
                                <div class="col-xs-12 col-sm-3 mt-1 col-md-3 form-group ">
                                    ...
                                    <i class="fa fa-calendar"  style="right: 22px;"></i>
                                </div>
                                <div class="col-xs-12 col-sm-3 mt-1 col-md-3 form-group custom-select">
                                    ...
                                    <i class="fa fa-car"  style="right: 22px;"></i>
                                </div>
                                <div class="col-xs-12 col-sm-3 mt-1 pe-1 col-md-2 form-group">
                                                ...
                                                <div class="col-4 col-xs-3">
                                                    <div class="card">
                                                        <img
                                                                ...
                                                                class="card-img-top"
                                                                alt="<?= $offers[$offer_position]->title  ?>"
                                                        />
                                                        <div class="card-body">
                                                            <b class="" style="@media(max-width: 500px){font-size(4rem);}"><?= $offers[$offer_position]->title  ?></b>
