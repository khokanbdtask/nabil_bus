            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        ...
                        <a type="button" onclick="printContent('PrintMe')" class="btn btn-sm btn-danger"><i
            ...
            <div class="panel-body" id="PrintMe">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <table class="table table-hover" width="100%">
                            ...
                            <tr>
                                <th colspan="2"><img
                                            src="<?php echo base_url((!empty($passenger->image) ? $passenger->image : 'assets/img/icons/default.jpg')) ?>"
                ...
                <div class="row">
                    <table class="table table-bordered ">
                        <caption>
                            <center><h3><?php echo display('ticket_information') ?></h3></center>
                        </caption>
                        <thead>
                        <tr>
