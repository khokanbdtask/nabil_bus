...
class Passenger extends MX_Controller
{
    ...
    public function form($id = null)
    {
        ...
        /*-----------------------------------*/
        if ($image = $this->fileupload->do_upload('./application/modules/passenger/assets/images/passenger/', 'image')) {
...
//			    die();
                ...
                if ($this->passenger_model->create($postData)) {
                    ...
                    redirect('passenger/view/' . $id);
                } else {
                    $this->session->set_flashdata('exception', display('please_try_again'));
                }
                redirect("passenger/form");
                ...
                redirect("passenger/form/" . $postData['id']);
