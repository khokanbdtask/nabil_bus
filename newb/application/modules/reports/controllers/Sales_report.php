...
public function report()
	{   
        ...
        $trip_name = $this->db->select('*')->from('trip')->where('trip_id',$this->input->get('trip'))->get()->row();
        $route_name = $this->db->select('*')->from('trip_route')->where('id',$this->input->get('route'))->get()->row();
        #-------------------------------#
        #
        #pagination starts
        #
        ...
        $data['trip_name'] = $trip_name->trip_title;
        $data['route_name'] = $route_name->name;
