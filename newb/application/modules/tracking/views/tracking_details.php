        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <?php if($this->permission->method('tracking', 'read')->access()): ?>
                        <a href="<?php echo base_url('/tracking/tracking_controller/create_tracking') ?>" class="btn btn-sm btn-success" title="Add"><i class="fa fa-list"></i> <?php echo display('tracking_list') ?></a> 
                        <?php endif; ?>
