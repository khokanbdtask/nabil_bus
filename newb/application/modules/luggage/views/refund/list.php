        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <a href="<?php echo base_url('luggage/refund/form') ?>" class="btn btn-sm btn-info" title="Add"><i
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($this->permission->method('ticket', 'delete')->access()): ?>
                                        <a href="<?php echo base_url("luggage/refund/delete/$refund->luggage_booking_id_no") ?>"
