<div class="form-group text-right">
    <a href="<?php echo base_url('luggage/packages/'); ?>">
        <button type="button" class="btn btn-primary btn-md">
            <?php echo display('package_list') ?>
        </button>
    </a>
    <a href="<?php echo base_url('luggage/packages/create_price'); ?>">
        <button type="button" class="btn btn-primary btn-md">
            <?php echo display('add_package') ?>
        </button>
    </a>
    <a href="<?php echo base_url().'luggage/packages/price_update/'.$bb['package_id']; ?>">
        <button type="button" class="btn btn-primary btn-md">
