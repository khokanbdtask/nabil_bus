                            ...
                            <tr class="<?php echo(!empty($booking->tkt_refund_id) ? "bg-danger" : null) ?>">
                                ...
                                <td>
                                    <?php if ($this->permission->method('ticket', 'read')->access()): ?>
                                        <a href="<?php echo base_url("luggage/luggage/view/$booking->id_no") ?>"
                                           class="btn btn-success btn-xs" data-toggle="tooltip" data-placement="left"
                                           title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                    <?php endif; ?>

                                    <?php if ($this->permission->method('ticket', 'update')->access() && empty($booking->luggage_refund_id)): ?>
                                        <a href="<?php echo base_url("luggage/refund/form?bid=$booking->id_no&pid=$booking->luggage_passenger_id_no") ?>"
                                    ...
                                    <?php if ($this->permission->method('ticket', 'delete')->access()): ?>
                                        <a href="<?php echo base_url("luggage/luggage/delete/$booking->id") ?>"
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <?= form_open('luggage/luggage/booking_paid') ?>
