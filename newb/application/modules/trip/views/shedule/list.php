        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <a href="<?php echo base_url('trip/shedule/add_shedule') ?>" class="btn btn-sm btn-info"
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($this->permission->method('trip', 'update')->access()): ?>
                                        <a href="<?php echo base_url("trip/shedule/add_shedule/$shedules->shedule_id") ?>"
                                    ...
                                    <?php if ($this->permission->method('trip', 'delete')->access()): ?>
                                        <a href="<?php echo base_url("trip/shedule/delete_shedule/$shedules->shedule_id") ?>"
