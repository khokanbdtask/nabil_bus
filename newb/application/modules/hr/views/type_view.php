                ...
                <div class="panel-title">
                    <h4>
                        <?php if ($this->permission->method('hr', 'create')->access()): ?>
                            <a href="<?php echo base_url('/hr/hr_controller/create_emtype') ?>"
                               class="btn btn-sm btn-info" title="List"><i
                            ...
                            <tr>
                                ...
                                <td class="center">
                                    <?php if ($this->permission->method('hr', 'update')->access()): ?>
                                        <a href="<?php echo base_url("hr/hr_controller/type_update/$query->type_id") ?>"
                                           class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a>
                                    <?php endif; ?>


                                    <?php if ($this->permission->method('hr', 'delete')->access()): ?>
                                        <a href="<?php echo base_url("hr/hr_controller/type_delete/$query->type_id") ?>"
