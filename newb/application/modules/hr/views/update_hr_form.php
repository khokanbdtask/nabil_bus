        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <a href="<?php echo base_url('hr/hr_controller/hrView') ?>" class="btn btn-sm btn-success"
                           title="List"><i class="fa fa-list"></i> <?php echo display('list') ?></a>

                        <?php if ($this->permission->method('hr', 'create')->access()): ?>
                            <a href="<?php echo base_url('hr/hr_controller/create_hr') ?>" class="btn btn-sm btn-info"
            ...
            <div class="panel-body">
                <?php echo img($data->picture, 'height="120px"', 'width="120px"'); ?>
                <?= form_open_multipart('hr/hr_controller/hr_update/' . $data->id) ?>
                ...
                <div class="form-group row">
                    ...
                    <label for="second_name" class="col-sm-2 col-form-label"><?php echo display('second_name') ?>
                        *</label>
                    <div class="col-sm-4">
                        <input name="second_name" class="form-control" type="text"
                               placeholder="<?php echo display('second_name') ?>" id="second_name"
                               value="<?php echo $data->second_name; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="position" class="col-sm-2 col-form-label"><?php echo display('position') ?> *</label>
                    <div class="col-sm-4">
                        <?php echo form_dropdown('position', $cat, $bb['position'], 'class="form-control"'); ?>
                    </div>
                    <label for="document_id"
                           class="col-sm-2 col-form-label"><?php echo display('document_id') ?></label>
                    <div class="col-sm-4">
                        <input name="document_id" class="form-control" type="text"
                               placeholder="<?php echo display('document_id') ?>" id="agent_document_id"
                               value="<?php echo $data->document_id; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <label for="document_pic"
                           class="col-sm-2 col-form-label"><?php echo display('document_pic') ?> </label>
                    <div class="col-sm-4">
                        <input name="document_pic" class="form-control" type="file"
                               placeholder="<?php echo display('document_pic') ?>" id="document_pic">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="phone_no" class="col-sm-2 col-form-label"><?php echo display('phone_no') ?> *</label>
                    <div class="col-sm-4">
                        <input name="phone_no" class="form-control" type="text"
                               placeholder="<?php echo display('phone_no') ?>" id="phone_no"
                               value="<?php echo $data->phone_no; ?>">
                    </div>
                    <label for="email_no" class="col-sm-2 col-form-label"><?php echo display('email_no') ?> </label>
                    <div class="col-sm-4">
                        <input name="email_no" class="form-control" type="email"
                               placeholder="<?php echo display('email_no') ?>" id="email_no"
                               value="<?php echo $data->email_no; ?>">
                    </div>

                </div>
                <div class="form-group row">
                    <label for="blood_group"
                           class="col-sm-2 col-form-label"><?php echo display('blood_group') ?> </label>
                    <div class="col-sm-4">
                    ...
                    <label for="address_line_1"
                           class="col-sm-2 col-form-label"><?php echo display('address_line_1') ?></label>
                    <div class="col-sm-4">
                        <textarea name="address_line_1" class="form-control"
                                  placeholder="<?php echo display('address_line_1') ?>"
                                  id="address_line_1"><?php echo $data->address_line_1; ?></textarea>
                    </div>

                </div>
                <div class="form-group row">
                    <label for="address_line_2"
                           class="col-sm-2 col-form-label"><?php echo display('address_line_2') ?> </label>

                    <div class="col-sm-4">
                        <textarea name="address_line_2" class="form-control"
                                  placeholder="<?php echo display('address_line_2') ?>"
                                  id="address_line_2"><?php echo $data->address_line_2; ?></textarea>
                    </div>
                    <label for="country" class="col-sm-2 col-form-label"><?php echo display('country') ?> </label>
                    <div class="col-sm-4">
                        <!--  <input name="country" class="form-control" type="text" placeholder="<?php echo display('country') ?>" id="country"  value=" <?php echo $data->country; ?>"> -->
                        <select name="country" class="form-control" style="width: 100%">
                            <option value="<?php echo $data->country; ?>"><?php echo $bb['country']; ?></option>
                ...
                <div class="form-group row">
                    ...
                    <label for="zip" class="col-sm-2 col-form-label"><?php echo display('zip') ?></label>
                    <div class="col-sm-4">
                        <input name="zip" class="form-control" type="text" placeholder="<?php echo display('zip') ?>"
                               id="zip" value="<?php echo $data->zip; ?>">
                    </div>
                ...
                <input type="hidden" name="document_pic" value="<?php echo $data->document_pic ?>">
